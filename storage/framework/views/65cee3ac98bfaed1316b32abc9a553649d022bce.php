                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="" method="post"
                                                        action="<?php echo e(route('vendorcategory.main.store')); ?>"
                                ...
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <table class="table" id="table" data-click-to-select="true" data-sort-name="id"
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $category_main; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categories): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td>#<?php echo e($loop->iteration); ?></td>
                                                    <td>
                                                        <div class="d-flex">
                                                            <img src="<?php echo e(asset('assets/images/categoryMain') . '/' . $categories->category_main_image); ?>"
                                                                alt=""
                                                                class="img-fluid img-40 me-2 blur-up lazyloaded">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <?php echo e($categories->category_main_name); ?>
                                                    ...
                                                    <td>
                                                        <span class="d-flex">
                                                            <button type="button" class="edit_category_main btn btn-secondary mx-1" value="<?php echo e($categories->id); ?>">
                                                                <i class="fa fa-pencil"></i></button>
                                                            <!--<a href="<?php echo e(route('category.main.edit', $categories->id)); ?>" class="btn btn-secondary mx-1"-->
                                                            <!--    data-bs-toggle="modal" data-original-title="test"-->
                                                            <!--    data-bs-target="#exampleModal"data-original-title="Edit"><i-->
                                                            <!--        class="fa fa-pencil"></i>-->
                                                            <!--</a>-->
                                                            <form
                                                                action="<?php echo e(route('vendorcategory.main.destroy', $categories->id)); ?>"
                                                                method="post">
...
$(document).on('click','.edit_category_main', function(e){
    ...
    var url ="<?php echo e(route('vendorcategory.main.edit', ":cate_id")); ?>";
    ...
    $(document).on('submit','#updatecate', function(e){
        ...
        var url ="<?php echo e(route('vendorcategory_main_update', ":updatecate_id")); ?>";
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/vendor/category/category_main.blade.php ENDPATH**/ ?>