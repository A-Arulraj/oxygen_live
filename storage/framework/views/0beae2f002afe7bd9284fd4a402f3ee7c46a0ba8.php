 ...
 <?php echo $__env->make('website.front-end.newhead', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="product-slick">
                            <div><img src="<?php echo e(asset('assets/images/products/detail') . '/' . $product_det[0]->product_detail_image); ?>" alt=""
                                                                        ...
                                                                        <div class="img-wrapper">
                                                                            <div class="front">
                                                                                <a href="<?php echo e(route('addtocart', $productdetail->id )); ?>"><img
                                                                                        src="<?php echo e(asset('assets/images/products/detail') . '/' . $productdetail->product_detail_image); ?>"
    ...
    <section class="section-b-space ratio_asos">
        <div class="container">
            ...
            <div class="row search-product">
                ...
                $productdetails = App\Models\Products\ProductsDetails::where('products_id',$pro->product_id)->get();
               // dd($productdetails);
                //  print_r($productdetails);
               // print_r($category);
               ...
               <?php $__currentLoopData = $productdetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $products): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-xl-2 col-md-4 col-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="<?php echo e(asset('assets/images/products/detail') . '/' . $products->product_detail_image); ?>"
    ...
    <?php echo $__env->make('website.front-end.newfooter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\mano\oxygen-new\resources\views/website/front-end/product_view.blade.php ENDPATH**/ ?>