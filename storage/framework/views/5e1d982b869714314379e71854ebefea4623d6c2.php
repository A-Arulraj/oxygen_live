                            ...
                            <span class="on"  value="1" id="active">Active</span><!--END--></div>
										...
										<td><span class="d-flex"> 
											...
											<button type="button" class="edit_designation btn btn-secondary mx-1" data-bs-toggle="modal" data-original-title="Edit" value="<?php echo e($item->id); ?>" id="edit_designation">
												...
												<form
												action="<?php echo e(route('staffdesignation.master.destroy', $item->id)); ?>"
												method="post">
...
<script>
    ...
    //    console.log(pin_id);
     $('#exampleModal1').modal('show');
		 ...
		 var url= "<?php echo e(route('staffdesignation.master.edit', ":id")); ?>";
	...
	var status = $('#editstatus').val();
			 ...
			 var url= "<?php echo e(route('staffdesignation.master.update', ":id")); ?>";
			 url = url.replace(":id", id);
   ...
   // url = url.replace(":updateid", updateid);
    $.ajax({
        //   data: $('').serialize(),    <?php echo e(url('admin/zonalupdate')); ?>/"+id+"/update"
             // url: "<?php echo e(url('admin/zonalupdate')); ?>/"+updateid,
              //console.log(id);
         action: "<?php echo e(route('staffdesignation.master.store')); ?>", 
         type: "POST",
	...
	<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/staff/master/designation.blade.php ENDPATH**/ ?>