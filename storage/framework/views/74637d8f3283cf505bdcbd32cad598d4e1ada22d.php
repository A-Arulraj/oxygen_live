                        ...
                        <div class="col-md-3">  
                            <select class="specification form-control text-secondary" id="specification[${x}]" name="specification[]"> 
                                ...
                                <?php $__currentLoopData = $specification; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option id="<?php echo e($specification->id); ?>"
                                        value="<?php echo e($specification->specification_name); ?>">
                                        <?php echo e($specification->specification_name); ?>
...
<?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/paritials/js/product/add-product-js.blade.php ENDPATH**/ ?>