                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="" method="post"
                                                        action="<?php echo e(route('vendorcategory.store')); ?>"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="d-flex">
                                                        ...
                                                        <form action="<?php echo e(route('vendorcategory.destroy', $categories->id)); ?>"
                                                            method="post">
    ...
    //    console.log(pin_id);
     $('#exampleModal1').modal('show');
	  ...
	  // var pin_id = $(this).val();
		 ...
		 var url= "<?php echo e(route('vendorcategory.edit', ":id")); ?>";
       ...
       $(document).on('submit','#UPDATEFORM', function(e){
        ...
        var url ="<?php echo e(route('vendorcategory_update', ":updatecate_id")); ?>";
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/vendor/category/category.blade.php ENDPATH**/ ?>