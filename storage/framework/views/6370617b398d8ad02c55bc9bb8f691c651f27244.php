						...
						<button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-original-title="test" data-bs-target="#exampleModal"><i class="fa fa-plus"></i> Create Types</button>
									...
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<div class="modal-body">
												<form class="" action="<?php echo e(route('vendorfacebook.store')); ?>" method="post" onsubmit="return confirm('Are you sure, you want to Save it?')">
													<?php echo csrf_field(); ?>
								...
								<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<div class="modal-body">
												<form class="" action="<?php echo e(route('vendorfacebook.update', 1)); ?>" method="post" onsubmit="return confirm('Are you sure, you want to Save it?')">
													<?php echo csrf_field(); ?>
							...
							<div class="datatable-dashv1-list custom-datatable-overright">                            
                            	<table class="table" id="table"  data-click-to-select="true" data-show-columns="true" data-sort-name="id" data-sort-order="asc" data-mobile-responsive="true" data-toggle="table" data-sort="true" data-pagination="true" data-search="true"  data-show-refresh="true" data-key-events="true"  data-resizable="true" data-cookie="true"
                                    ...
                                    <tbody>
										<?php $__currentLoopData = $fb; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<tr>
										...
										<td><span class="d-flex">
											...
											<form
											action="<?php echo e(route('vendorfacebook.destroy', $item->id)); ?>"
											method="post">
...
<script>
    $(document).on('click', '.edit_facebook', function(e){
		...
		console.log(ad_id);
        var url = "<?php echo e(route('vendorfacebook.edit', ":ad_id")); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/vendor/marketing/facebook.blade.php ENDPATH**/ ?>