                ...
                <div class="col-sm-9">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
							...
							<?php endif; ?>
                            <form id="frmOffer" name="frmOffer" class="needs-validation" method="POST" action="<?php echo e(route('vendoroffer.main.store')); ?>">
							 <?php echo csrf_field(); ?>	
                                <div class="row">
                                    <div class="col-sm-12">
                ...
                <div class="form-group row ">
                    <div class="text-center">
                        <div class="col-xl-8 col-md-8">
                            ...
                            <a href="<?php echo e(route('vendoroffer.main.index')); ?>" class="btn btn-secondary " type="button">Close</a>
                        </div>
                    </div>
                    </form>
                </div>
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/vendor/offer/offers-create.blade.php ENDPATH**/ ?>