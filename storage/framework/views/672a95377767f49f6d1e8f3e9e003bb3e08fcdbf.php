    ...
    <section class="pt-0 section-b-space ratio_asos">
        <div class="container-fuild">
            <div class="row game-product grid-products px-5">
                ...
                <?php $__currentLoopData = $vendorcreate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendorcreate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    // dd($vendorcreate);
                     ...
                     ?>
                        ...
                        <div class="product-box col-xl-2 col-lg-3 col-sm-4 col-6">
                            <div class="img-wrapper">
                                <div class="front">
                                    ...
                                    ?>
                                            ...
                                            <a href=""><img
                                            src="<?php echo e(asset('assets/images/vendor/profile') . '/' .  $vendorcreate->profile_image); ?>"
                            ...
                            <div class="product-detail">
                                <h6><?php echo e($vendorcreate->username); ?></h6>
                                <a href="">
                                    <h6><?php echo e($vendorcreate->business_category); ?></h6>
                                </a>
...
</html><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/website/front-end/allvendors.blade.php ENDPATH**/ ?>