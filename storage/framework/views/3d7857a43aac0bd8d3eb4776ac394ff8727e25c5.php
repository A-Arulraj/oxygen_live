            ...
            <div class="container-fluid fcolor">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <!--<div class="mt-3">
                                <a href="<?php echo e(route('vendorproducts.crud.index', $vendorid)); ?>">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $products_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $products): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php  $vendorcreate = App\Models\vendor\vendorcreate::where('id', $products->login_id)->first(); ?>#<?php echo e($vendorcreate->id); ?> ( <?php echo e($vendorcreate->shop_name); ?>)</td>
                                                ...
                                                <td class="text-center">
                                                    <span class="fw-bold">
                                                        <a  data-id=<?php echo e($products->id); ?>

                                                            class="text-danger productDetails" 
                                                            
                                                            ><?php echo e($products->vendor_product_details_cnt); ?></a>
                                                    </span>
                                                </td>
                                               ...
                                               <td>
                                                    <div class="mt-2 d-flex">
                                                        <a href="<?php echo e(route('vendor_products.admin.view',  ['id'=>$products->id, 'sub_id'=>$products->category_sub,])); ?>"
                                                            class="btn btn-secondary mx-1"><i class="fa fa-eye" aria-hidden="true"></i>
                                                        </a>

                                                       
                                                        <form action="<?php echo e(route('vendor_products.admin', $products->id )); ?>"
                                                            method="post">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(".productDetails").click(function() {
                ...
                let url = '<?php echo e(route('getvendorProductDetails')); ?>?product_id=' + product_id;
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\skap\oxygen-new\resources\views/layout/admin/products/vendor_product-listing.blade.php ENDPATH**/ ?>