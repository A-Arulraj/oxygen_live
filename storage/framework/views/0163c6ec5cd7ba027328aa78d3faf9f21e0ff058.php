                                                    ...
                                                    <div class="container" id="product_details"> 
                                                        ...
                                                        <div class="w row">                                                                  
                                                            ...
                                                            <div class='col-md-2'><div class="img-thumb-wrapper card shadow">
                                                                <img class="img-thumb" id="mainr<?php echo e($key); ?>"  src="<?php echo e(url('assets/images/products/detail/'.$val)); ?>"   />
                                                            ...
                                                            <?php if($ke == 1): ?>
                                                            <div class='col-md-2'><div class="img-thumb-wrapper card shadow">
                                                                <img class="img-thumb" id="sub1r<?php echo e($key); ?>"  src="<?php echo e(url('assets/images/products/detail/'.$val)); ?>"   />
                                                            ...
                                                            <?php if($ke == 2): ?>
                                                            <div class='col-md-2'><div class="img-thumb-wrapper card shadow">
                                                                <img class="img-thumb" id="sub2r<?php echo e($key); ?>"  src="<?php echo e(url('assets/images/products/detail/'.$val)); ?>"   />
                                                            ...
                                                            <?php if($ke == 3): ?>
                                                            <div class='col-md-2'><div class="img-thumb-wrapper card shadow">
                                                                <img class="img-thumb" id="sub3r<?php echo e($key); ?>"  src="<?php echo e(url('assets/images/products/detail/'.$val)); ?>"   />
...
/*image preview*/
    ...
    </script><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/vendor/products/producteditDetails.blade.php ENDPATH**/ ?>