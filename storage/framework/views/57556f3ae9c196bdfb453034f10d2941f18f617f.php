                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="<?php echo e(route('staffvendorcreate.index')); ?>" class="btn  btn-primary"><i class="fa fa-plus"></i> Add
                                    vendor</a>
                                ...
                                ?>
                                            ...
                                            <td>
                                                <div class="mt-2 d-flex">
                                                    ...
                                                    <form action="<?php echo e(route('staffvendorcreate.edit', $vendor_list->id)); ?>"
                                                        method="get">
                                                    ...
                                                    <button type="submit" class="btn btn-secondary mx-1">
                                                        ...
                                                        <form action="<?php echo e(route('staffvendorcreate.destroy', $vendor_list->id)); ?>"
                                                            method="post">
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/staff/vendor/vendor-list.blade.php ENDPATH**/ ?>