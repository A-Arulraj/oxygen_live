...
<?php $__env->startSection('contents'); ?>
                                        ...
                                        <?php $__currentLoopData = $specification; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                         <?php $spc++; ?>
                                            <tr>
                                                ...
                                                <td>
                                                     <span class="d-flex">
                                                    <button type="button" class="edit_spec btn btn-secondary mx-1" data-bs-toggle="modal" data-original-title="Edit" value="<?php echo e($specification->id); ?>" id="edit_spec">
													...
													<form
																action="<?php echo e(route('product.specification.destroy', $specification->id)); ?>"
																method="post">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="" method="post" action="<?php echo e(route('product.specification.store')); ?>"
                            ...
                            <div class="form">
                                <div class="form-group">
                                    ...
                                    <select name="category_sub_id" id="category_sub_id" class="custom-select form-control" required>
                                        ...
                                        <!--    <option id="<?php echo e($subcategory->id); ?>" value="<?php echo e($subcategory->id); ?>"><?php echo e($subcategory->category_sub_name); ?>-->
                                        <!--<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>-->
                                    </select>
                                </div>
                                <!--<span id="cate1"></span>-->
    ...
    $.ajax({
        //   data: $('').serialize(),  <?php echo e(url('admin/pincode1')); ?>/"+pin_id+"/edit"
          url: "<?php echo e(url('admin/editspec')); ?>/"+id+"/edit",          
          type: "get",
          dataType: 'json',
    ...
    function showModal() {
        ...
        $(document).on('submit','#UPDATEFORM', function(e){
            ...
            var url ="<?php echo e(route('specupdate', ":updatecate_id")); ?>";
...
/*Category Details*/
 ...
 function getAjaxValue(url, method, callback) {
        ...
        $('#category_sub_id').on('change', function() {
            ...
            let url = '<?php echo e(route('scatedetails')); ?>?sub_category_id=' + sub_category_id;
            let method = 'GET';
            $("#cate1").html('');
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/admin/products/specification-listing.blade.php ENDPATH**/ ?>