            ...
            <div class="container-fluid fcolor">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="mt-3">
                                <a href="<?php echo e(route('products.crud.index')); ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <span class="fw-bold">
                                                        <a href="#" data-id=<?php echo e($products->id); ?>
                                                            ...
                                                            data-bs-target="#stockModal"><?php echo e($products->product_details_cnt); ?></a>
                                                    </span>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="mt-2 d-flex">
                                                        <a href="<?php echo e(route('products.crud.view', $products->id)); ?>"
                                                            class="btn btn-secondary mx-1"><i class="fab fa-mdb"></i>
                                                        </a>

                                                        <a href="<?php echo e(route('products.crud.edit', ['id'=>$products->id, 'sub_id'=>$products->category_sub])); ?>"
                                                            class="btn btn-secondary mx-1"><i class="fa fa-pencil"></i>
                                                        </a>
                                                        <form action="<?php echo e(route('products.crud.destroy', $products->id)); ?>"
                                                            method="post">
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\oxygen-new\resources\views/layout/admin/products/product-listing.blade.php ENDPATH**/ ?>