...
<?php $__env->startSection('contents'); ?>
                            ...
                            <div class="card-body">
                                ...
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table class="table" id="table" data-click-to-select="true"
                                        ...
                                        <tbody>
                                            <!--<?php dd($data->routeList); ?>;-->
                                            <!--<?php if(count($data->routeList) != null): ?>-->
                                            <!--<?php $__currentLoopData = $data->routeList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>-->
                                            
                                            <?php $__currentLoopData = $data->routeList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rrr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            
                                            
                                                <tr>
                                                    <td><?php echo e($rrr->id); ?></td>
                                                    	<td>
                                                           ...
                                                           // dd($route->zonal_id);
                                                            ...
                                                            ?>
                                                             <?php echo e($rna[0]->name); ?>

                                                            
                                                            </td>
                                                    <td><?php echo e($rrr->name); ?></td>
                                                    ...
                                                    <td><span> 
                                                        ...
                                                        <button type="button" class="edit_route btn btn-secondary mx-1" value="<?php echo e($rrr->id); ?>">
                                                            <i class="fa fa-pencil"></i></button>
                                                                    ...
                                                                    <form
                                                                    action="<?php echo e(route('staffroutedelete', $rrr->id)); ?>"
                                                                    method="post">
                                                                    <?php echo method_field('POST'); ?>
                                                                    <?php echo csrf_field(); ?>
                                                                    <button type="submit" class="btn btn-warning mx-1" value="<?php echo e($rrr->id); ?>"
                                                ...
                                                <div class="btn-popup pull-right">
                                                    ...
                                                    <div class="modal fade" id="edit<?php echo e($rrr->id); ?>" tabindex="-1" role="dialog"
                                                        data-backdrop="false" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                             ...
                                             <div class="form-group">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control"  type="text"
                                                                                    name="editname" id="editname" required="true" value="<?php echo e($rrr->name); ?>">
                                                                            </div>
    ...
    <?php $__env->startPush('scripts'); ?>
            ...
            $(function() {
                var validation_option = getValidationOptions({
                    rules: {
                        name: {
                            required: true,
                            remote: {
                                url: "<?php echo e(route('staffchecRoutenamePost')); ?>",
                                type: "post",
                                data: {
                                    name: function() {
                                        return $("#name").val();
                ...
                function save(callBack) {
                    if ($('#form').valid()) {
                        ...
                        var url = "<?php echo e(route('saveRoute')); ?>";
        ...
        <script>
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(url('staff/editroute')); ?>/"+id+"/edit",          
                    type: "get",
                    dataType: 'json',
    ...
    var url = '<?php echo e(route("staffroute_update", ":id")); ?>';
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/staff/master/route.blade.php ENDPATH**/ ?>