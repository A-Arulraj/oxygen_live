                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="" method="post" action="<?php echo e(route('staffpincode1.store')); ?>" enctype="multipart/form-data">
                                                        <?php echo csrf_field(); ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <span class="d-flex">
                                                            ...
                                                            <form
                                                                action="<?php echo e(route('staffpincode1.destroy', $pin->id)); ?>"
                                                                method="post">
                                                                    ...
                                                                    <select class="custom-select w-100 form-control"
                                                                        ...
                                                                        <option value="">--Select Zone--</option>
                                                                         <?php $__currentLoopData = $zone; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>{
                                                                            <option value="<?php echo e($zo->id); ?>" hidden><?php echo e($zo->name); ?></option>
                                                                        }
                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>  
                                                                    </select>
                                                                </div>
...
<script>
    ...
    $.ajax({
        //   data: $('').serialize(),
          url: "<?php echo e(url('staff/pincode1')); ?>/"+pin_id+"/edit",          
          type: "get",
          dataType: 'json',
    ...
    // alert(post_region);
    // alert(status);
    var url ="<?php echo e(route('staffpincode1.update', ":updateid")); ?>";
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/staff/master/pincode.blade.php ENDPATH**/ ?>