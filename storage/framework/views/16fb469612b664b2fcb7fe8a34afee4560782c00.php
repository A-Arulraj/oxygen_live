									...
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<div class="modal-body">
												<form class="" method="post" action="<?php echo e(route('package.store')); ?>" enctype="multipart/form-data">
													<?php echo csrf_field(); ?>
													<div class="form">
								...
								<td>	
									...
									<label class="switch">
										 ...
										 <div class="slider round">
											...
											<form
												action="<?php echo e(route('package.destroy', $package->id)); ?>"
												method="post">
...
$(document).on('click','.edit_package', function(e){
    ...
    $.ajax({
        //   data: $('').serialize(),
          url: "<?php echo e(url('admin/package')); ?>/"+pack_id+"/edit",          
          type: "get",
          dataType: 'json',
...
// alert(desc);
    ...
    var url ="<?php echo e(route('package.update', ":updateid")); ?>";
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/admin/master/package.blade.php ENDPATH**/ ?>