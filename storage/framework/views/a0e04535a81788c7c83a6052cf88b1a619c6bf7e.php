                                ...
                                <form action="<?php echo e(route('userlogin')); ?>" method="post">
                                 <?php echo csrf_field(); ?>
                                    ...
                                    <div class="form-button text-center">
                                        ...
                                        <a  href=<?php echo e(url('/usersignin')); ?> type="button" name="submit" class="btn btn-warning">Register</a>
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/auth/userlogin.blade.php ENDPATH**/ ?>