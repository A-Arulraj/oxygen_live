                                                ...
                                                <table class="table fcolor" id="table" data-click-to-select="true" data-sort-name="id" data-sort-order="asc" data-mobile-responsive="true" data-toggle="table" data-show-columns="true" data-sort="true" data-pagination="true" data-search="true" data-show-refresh="true" data-key-events="true" data-resizable="true" data-cookie="true" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar" >
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo e($attribute->order_id); ?></td>
...
<script>
    ...
    //  alert(sts);
        ...
        url: "<?php echo e(url('vendar/orderstatusupdate')); ?>/"+btnnew, 
        type: "POST",
        data: {
               ...
               // alert("Accept.");  
                ...
                if(check == true){  
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(route('orderbulkstatusupdate')); ?>", 
                        type: "POST",
                        data: {
                            "_token": "<?php echo e(csrf_token()); ?>",
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/vendor/sales/order-list.blade.php ENDPATH**/ ?>