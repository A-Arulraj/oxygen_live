                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">												
                                                    <form class="" action="<?php echo e(route('advbanner.store')); ?>" method="post" onsubmit="return confirm('Are you sure, you want to Save it?')" enctype="multipart/form-data" >
                                                        <?php echo csrf_field(); ?>
                                                        <div class="form">
                                    ...
                                    <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" data-backdrop="false" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">												
                                                    <form class="" action="<?php echo e(route('advbanner.update', 0)); ?>" method="post" onsubmit="return confirm('Are you sure, you want to Update it?')" enctype="multipart/form-data" >
                                                        <?php echo csrf_field(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="d-flex">
                                                  ...
                                                  <form
                                                     action="<?php echo e(route('advbanner.destroy', $item->id)); ?>"
                                                     method="post">
...
<script>
    $(document).on('click', '.edit_advbaner', function(e){
        ...
        var url = "<?php echo e(route('editadvbanner', ":ad_id")); ?>";
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/admin/banner/advbanner.blade.php ENDPATH**/ ?>