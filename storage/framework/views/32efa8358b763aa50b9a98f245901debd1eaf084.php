...
<?php $__env->startSection('contents'); ?>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="" method="post"
                                                        action="<?php echo e(route('vendorcategory.sub.store')); ?>"
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $sub_category_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <img src="<?php echo e(asset('assets/images/categorySub') . '/' . $sub_category->category_sub_image); ?>"
                                                                alt=""
                                                                class="img-fluid img-30 me-2 blur-up lazyloaded">
                                                        </div>
                                                    </td>

                                                    <td><?php echo e($sub_category->category_main_name); ?>  </td>
                                                    <td><?php echo e($sub_category->category_name); ?>  </td>
                                                    <td><?php echo e($sub_category->category_sub_name); ?>  </td>
                                                    <td>
                                                        <label class="switch">
                                                         <?php if($sub_category->sc_status  == 1): ?>{
                                                                <input type="checkbox"
                                                    ...
                                                    <td>
                                                        <span class="d-flex">
                                                            <button type="button" class="edit_Sub_catagory btn btn-secondary mx-1" data-bs-toggle="modal" data-original-title="Edit" value="<?php echo e($sub_category->me_id); ?>" id="edit_Sub_catagory">
                                                                <i class="fa fa-pencil"></i> </button>
                                                            
                                                            <form
                                                                action="<?php echo e(route('vendorcategory.sub.destroy', $sub_category->me_id)); ?>"
                                                                method="post">
    ...
    //  alert(cate_id);
      ...
      var url ="<?php echo e(route('vendorcategory.sub.edit', ":cate_id")); ?>";
            ...
            success: function (response) {
               ...
               //alert(response);
                  ...
                  $('successmessage').text(response.message);
                    ...
                    $('#editcategory_id').val(response.category_sub.category_id);
    ...
    //         });
        ...
        var url ="<?php echo e(route('vendorsubcategory_update', ":updatecate_id")); ?>";
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/vendor/category/category_sub.blade.php ENDPATH**/ ?>