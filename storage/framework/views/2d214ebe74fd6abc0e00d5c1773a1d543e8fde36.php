...
unset($__errorArgs, $__bag); ?>
									...
									<div class="tab-pane fade" id="top-upload" role="tabpanel" aria-labelledby="top-upload-tab">
                                        ...
                                        <!--<form method="post" action="<?php echo e(url('admin/staff/update')); ?>" class="needs-validation user-add" novalidate="" enctype="multipart/form-data">-->
                                        <!--    <?php echo csrf_field(); ?>-->
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/staff/staff/staff-create.blade.php ENDPATH**/ ?>