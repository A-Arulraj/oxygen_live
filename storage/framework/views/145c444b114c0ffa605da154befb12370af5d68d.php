                                                                ...
                                                                <div class="conatiner">
                                                                    ...
                                                                    <table class="table table-bordered ">
                                                                        ...
                                                                        <tbody class="spectable">    
                                                                            ...
                                                                            <?php $__currentLoopData = $specification; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prspec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <select class="js-select2 form-control"  name="speci_value[]" id="speci_value[]">
                                                                                    <?php
                                                                                    $pr_spe_val = json_decode($prspec->value);  
                                                                                    ?>
                                                                                    <?php $__currentLoopData = $pr_spe_val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $prsv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                    <option value="<?php echo e($k); ?>">
                                                                                        <?php echo e($prsv); ?> </option>
                                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\skap\oxygen-new\resources\views/layout/vendor/products/EditProduct.blade.php ENDPATH**/ ?>