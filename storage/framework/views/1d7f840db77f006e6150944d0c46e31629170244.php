            ...
            <div class="row">
             <div class="col-sm-8">
                <div style="position: relative; display: inline-block; margin-top: 157px;">
                    ...
                    <?php if(!empty($vendorcreate->profile_image)): ?>
                    <img src="<?php echo e(asset('assets/images/vendor/profile') . '/' . $vendorcreate->profile_image); ?>" class="bg-size blur-up lazyloaded" height="300" width="900" alt="">
                    <?php endif; ?>
              ...
              <div class="col-sm-2" style="margin-top: 157px;">
                ...
                <p><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box2" viewBox="0 0 16 16">
                    ...
                    Products : <span style="color:red"><?php echo e($pep); ?></span></p>
...
<section class="" style="padding:15px;">
                    ...
                    <div class="col-xl-1 p-0 col-sm-1 col-3">
                        <a href="#">
                            <div class="img-category">
                                <a href="<?php echo e(url( 'vendorMainCatergoryproductshow/'.$categorymain1->id )); ?>">
                                <div class="img-sec">
                                    <img  src=" <?php echo e(asset('assets/images/categoryMain') . '/' . $categorymain1->category_main_image); ?> "class="img-fluid bg-img" alt="">
                                </div>
                                  </a>   
                                 <h6><?php echo e($categorymain1->category_main_name); ?></h6>
               ...
               // print_r($category);
                ?>
                                 ...
                                 <div align="center">
                                    <button class="btn btn-default filter-button" data-filter="all">All</button>
                                        ...
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                         ...
                                         <button class="btn btn-default filter-button" data-filter="tab-<?php echo e(str_replace(" ","-",$collection)); ?>"><?php echo e($collection); ?></button>
                                       <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                                <br/>
                                ...
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="gallery_product col-lg-2 col-md-2 col-sm-4 col-xs-6 filter tab-<?php echo e(str_replace(" ","-",$product->collection)); ?> tab-content  default">
                                        <div class="product-box">
                                            ...
                                            <div class="product-detail">
                                                ...
                                                <a href="<?php echo e(route('addtocart', $product->product_id )); ?>">
                                                    <?php if(!empty($vendorcreate->username)): ?>
                                                   <h6 style="background-color:lightgray;"><?php echo e($vendorcreate->username); ?></h6>
                                                    <?php endif; ?>
                                                   ...
                                                   <h6>Rs.<?php echo e($product->selling_price); ?> <del><?php echo e($product->retail_price); ?></del> <span style="color:red;">(<?php echo e(round($offerperc)); ?>%Off)</span></h6>
                                                </a>
   ...
   <?php echo $__env->make('website.front-end.newfooter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/website/front-end/vendorproduct.blade.php ENDPATH**/ ?>