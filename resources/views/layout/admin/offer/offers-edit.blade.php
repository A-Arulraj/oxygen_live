                        ...
                        <div class="card-body">
                            <div class="form-group row ">
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="txtBuyOffer" name="txtBuyOffer" value="{{$offer->buy}}" type="text">
                                </div>
                                <div class="col-md-1 text-center mt-3">
                                    <span class="h4 ">@</span>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="txtGetOffer" name="txtGetOffer"  value="{{$offer->getoffer}}" type="text">
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="" id="dates">
                                        <div class="form-group row">
                                            ...
                                            {{-- <div class="col-md-3">
                                                ...
                                                <input type="time" id="starttime" name="starttime"  class="form-control" value="{{$offer->ActiveStartTime}}" />
                                            </div> --}}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            {{-- <div class="col-md-3">
                                                ...
                                                <input type="time" id="endtime" name="endtime"  class="form-control"  value="{{$offer->ActiveEndTime}}"/>
                                            </div> --}}
                                        </div>
                                    </div>
                                </div>
