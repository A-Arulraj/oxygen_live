                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <select class="js-select2 form-control" id="main_category"
                                                                   ...
                                                                   <!-- <option selected  value="<?php echo e($product->id); ?>">

                                                                    <?php echo e($product->category_main); ?>
                                                            ...
                                                            <div id="clothing">
                                                                <select class="js-select2 form-control" name="category"
                                                                    id="category"  required>
                                                                        ...
                                                                        <option value="<?php echo e($product->category); ?>" hidden> <?php echo e($cates['0']->category_name); ?></option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div id="clothing">
                                                                <select class="js-select2 form-control" name="category_sub"
                                                                    ...
                                                                    <option value="  <?php echo e($product->category_sub); ?>" hidden> <?php echo e($cates['0']->category_sub_name); ?></option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-12 digital-add needs-validation">
                                                ...
                                                <?php echo $__env->make('layout.admin.products.productviewDetails', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                                    ...
                                                                    <table class="table table-bordered ">
                                                                        ...
                                                                        <tbody class="spectable">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <option value="<?php echo e($prspec->specify_attribute); ?>" hidden>
                                                                                    <?php echo e($prspec->specify_attribute); ?>
                                                                                ...
                                                                                <option value="<?php echo e($prspec->specify_value); ?>" hidden>
                                                                                    <?php echo e($prspec->specify_value); ?>  
                                                                                </option>
                                                                    ...
                                                                    <div class="row mt-3">
                                                                        ...
                                                                        <div class="col-md-3 ">
                                                                            <select class="form-select form-select-lg text-secondary"
                                                                                ...
                                                                                <option value="<?php echo e($offer->id); ?>" <?php echo e(($offer->id == $product->offers)?'selected':''); ?> hidden>
                                                                        ...
                                                                        <div class="col-md-4 ">
                                                                            <select class="form-select form-select-lg text-secondary"
                                                                                ...
                                                                                <option hidden><?php echo e($product->collection); ?></option>
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\mano\oxygen-new\resources\views/layout/vendor/products/ViewProduct.blade.php ENDPATH**/ ?>