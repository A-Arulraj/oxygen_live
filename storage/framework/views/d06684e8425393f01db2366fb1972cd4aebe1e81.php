                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="" method="post" action="<?php echo e(route('pincode1.store')); ?>" enctype="multipart/form-data">
                                                        <?php echo csrf_field(); ?>
...
<?php if($pincode): ?>
                                            <?php $__currentLoopData = $pincode; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e($pin->routename); ?></td>
                                                    <td><?php echo e($pin->zonalname); ?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <span class="d-flex">
                                                            <button type="button" value="<?php echo e($pin->id); ?>" class="edit_pincode btn btn-secondary mx-1"> <i
...
<script>
    ...
    $.ajax({
        //   data: $('').serialize(),
          url: "<?php echo e(url('admin/pincode1')); ?>/"+pin_id+"/edit",          
          type: "get",
          dataType: 'json',
    ...
    // alert(post_region);
    // alert(status);
    var url ="<?php echo e(route('pincode1.update', ":updateid")); ?>";
    ...
    $.ajax({
        //   data: $('').serialize(),
          ...
          type: "PUT",
          data: {_token : `<?php echo e(csrf_token()); ?>`, route_id:route_id,zonal_id:zonal_id,name:name,area:area,post_region:post_region,status:status},
         dataType: 'html',
          success: function (response) {
               //console.log(response);
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\oxygen-new\resources\views/layout/admin/master/pincode.blade.php ENDPATH**/ ?>