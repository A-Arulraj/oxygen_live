                    ...
                    <?php $__currentLoopData = $productdetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productdetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="product-box col-xl-2 col-lg-3 col-sm-4 col-6">
                            ...
                            <div class="product-detail">
                                ...
                                <h6><b><?php echo e($products->product_name); ?></b></h6>
                                            <?php
                                            $disc = $productdetail->retail_price -$productdetail->selling_price;
                                            $offerperc = $disc/$productdetail->retail_price *100;
                                            ?>
                                            <h6>Rs.<?php echo e($productdetail->selling_price); ?> <del>Rs <?php echo e($productdetail->retail_price); ?></del><span style="color:red;">(<?php echo e(round($offerperc)); ?>%Off)</span></h6>
                                            
                                            <ul class="color-variant">
                                             <li style="background-color:<?php echo e($productdetail->color); ?>;"></li>
                                            </ul>
...
</html><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/website/front-end/allpro_details.blade.php ENDPATH**/ ?>