						...
						<button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-original-title="test" data-bs-target="#exampleModal"><i class="fa fa-plus"></i> Create Types</button>
									...
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<div class="modal-body">
												<form class="" action="<?php echo e(route('vendorwhatsapp.store')); ?>" method="post" onsubmit="return confirm('Are you sure, you want to Save it?')" enctype="multipart/form-data">
													<?php echo csrf_field(); ?>
								...
								<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<div class="modal-body">
												<form class="" action="<?php echo e(route('vendorwhatsapp.update', 1)); ?>" method="post" onsubmit="return confirm('Are you sure, you want to Save it?')" enctype="multipart/form-data">
													<?php echo csrf_field(); ?>
							...
							<div class="datatable-dashv1-list custom-datatable-overright">                            
                            	<table class="table" id="table"  data-click-to-select="true" data-show-columns="true" data-sort-name="id" data-sort-order="asc" data-mobile-responsive="true" data-toggle="table" data-sort="true" data-pagination="true" data-search="true"  data-show-refresh="true" data-key-events="true"  data-resizable="true" data-cookie="true"
                                    ...
                                    <tbody>
										<?php $__currentLoopData = $whapp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<tr>
										<td><?php echo e($loop->iteration); ?></td>
										<td>
											
											<div class="d-flex">
											<img src="<?php echo e(asset('assets/images//Marketting/Wh_app_template'). '/' .$item->image); ?>" alt="" class="img-fluid img-40 me-2 blur-up lazyloaded"> 
											</div>
										</td>
										<td>
											<div class="d-flex">
										...
										<td><?php echo e($item->line1); ?></td>
										<td><?php echo e($item->line2); ?></td>
										...
										<td><span class="d-flex">
											<button type="button" value="<?php echo e($item->id); ?>" class="edit_facebook btn btn-secondary mx-1"> 
												<i class="fa fa-pencil"></i></button> 
											
											<form
											action="<?php echo e(route('vendorwhatsapp.destroy', $item->id)); ?>"
											method="post">
...
<script>
    $(document).on('click', '.edit_facebook', function(e){
		...
		console.log(ad_id);
        var url = "<?php echo e(route('vendorwhatsapp.edit', ":ad_id")); ?>";
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/vendor/marketing/whatsapp.blade.php ENDPATH**/ ?>