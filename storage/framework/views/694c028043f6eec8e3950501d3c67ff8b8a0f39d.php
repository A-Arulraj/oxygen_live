                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $products_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $products): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            //   $produ = App\Models\vendor\vendorcreate::where('user_id',$products->login_id)->get();
                                                ...
                                                ?>
                                                <td><?php echo e('-'.$login_id . '-'.$pro_id); ?></td>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <span class="fw-bold">
                                                        <a href="#" data-id=<?php echo e($products->id); ?>
                                                            ...
                                                            data-bs-target="#stockModal"><?php echo e($produ1); ?></a>
                                                    </span>
                                                </td>
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/admin/products/product-listing.blade.php ENDPATH**/ ?>