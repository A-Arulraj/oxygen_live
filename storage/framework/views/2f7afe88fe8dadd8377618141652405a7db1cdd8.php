                                            ...
                                            <div data-role="dynamic-fields">
                                             <div class="form-inline form-row">
                                                <div class="container" id="product_details">
                                                    ...
                                                    <?php $__currentLoopData = $productdetailss; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productdetails): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="row">
                                                        <div class="col-md-3">

                                                            <div class="form-group">
                                                                <label class="">Option 1</label>
                                                                <img src="<?php echo e(url('assets/images/products/detail/'.$productdetails->product_detail_image)); ?>" id="im1" name="nproducts[]" height="100" width="100">
                                                                

                                                                <input class="form-control add_product" type="file" id="im1" name="nproducts[]" multiple accept="image/*">
                                                                
                                                                <input class="form-control" type="hidden" id="im1" name="oldnproducts[]" value="<?php echo e($productdetails->product_detail_image); ?>">
                                                              </div>
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <?php $__currentLoopData = $productsAttri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productsAttr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                            
                                                                <div class="col-md-3">
                                                                    <input type="text" name="spec_attribute[]"
                                                                        placeholder="" class="form-control" required value="<?php echo e($productsAttr->spec_attribute); ?>">
                                                                </div>


                                                                <div class="col-md-3">
                                                                    <input type="text" name="spec_value[]"
                                                                        placeholder="spec_value" class="form-control" required value="<?php echo e($productsAttr->spec_value); ?>">
                                                                </div>
                                                            ...
                                                            <div class="row mt-3">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="number" name="low_stock_limit[]"
                                                                        placeholder="Low Stock Limit" class="form-control" required value="<?php echo e($productdetails->low_stock_limit); ?>">
                                                                </div>  
...
/*image preview*/
    ...
    </script><?php /**PATH F:\mano\oxygen-new\resources\views/layout/admin/products/productviewDetails.blade.php ENDPATH**/ ?>