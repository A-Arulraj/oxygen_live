...
$.ajax({
              ...
              success: function(response) {
                  console.log(response);
                  getcart();
                  window.location.href = "<?php echo e(route('viewcart')); ?>";
                  //viewcart();
   ...
   // alert('1');
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.sum == 0) {
                var cart_dt = '<li> <div class="minicart-item"><img src="<?php echo e(asset('frontend_assets/images/emptycart.png')); ?>" alt="Your Cart Is Empty"> </div></li>';
            } else {
                cart_dt = "";
               // alert('2');
           ...
           // alert('3');
            ...
            cart_dt+='<li><div class="total"><h5>Total : <span class="total"> Rs ' + data.sum+'</span></h5></div></li><li><div class="buttons"><a href="<?php echo e(route('viewcart')); ?>" class="view-cart">view cart</a><a href="<?php echo e(route('checkout')); ?>" class="checkout">checkout</a></div></li>';
...
//                 });
//                 cart_dt += "</tr> <tr><td colspan='4'><span style='float:right'>  Subtotal:  Rs. " + data.sum + " <br>  <a href='<?php echo e(url('Checkout')); ?>' class='btn btn-danger'  data-minicartk-alt='undefined'>Check Out </a>  </span> </td> </tr></table>";
//             }
//             //$('#cart_dt').html(cart_dt);
//             //$('#myModal').modal('show');
...
if (confirm("Are you sure to remove cart?")) {
    ...
    if (product_id != '') {
        $.ajax({
            ...
            url: '<?php echo e(route("cartdelete")); ?>',
            type: "GET",
            data: {
                "_token": "<?php echo e(csrf_token()); ?>",
...
</script><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/paritials/js/userwebsite/cart_js.blade.php ENDPATH**/ ?>