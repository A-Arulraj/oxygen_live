            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="success-text">
                        ...
                        <p class="font-weight-bold">Transaction ID:<?php echo e($orders_id); ?></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6">
                    <div class="product-order">
                        ...
                        ?>
                                    ...
                                    <?php $__currentLoopData = $orders_pro; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       
                                        <div class="row product-order-detail">
                                            <div class="col-3"><img src="<?php echo e(asset('assets/images/products/detail') . '/' . $details['product_image']); ?>" alt=""
                                            ...
                                            <div class="col-2 order_detail">
                                                <div>
                                                    <h4>Product</h4>
                                                    <h5><?php echo e($details['product_name']); ?></h5>
                                                </div>
                                            </div>
                                            <div class="col-2 order_detail">
                                                <div>
                                                    <h4>Qty</h4>
                                                    <h5><?php echo e($details['product_quantity']); ?></h5>
                                                </div>
                                            </div>
                                            <div class="col-2 order_detail" style="float:right">
                                                <div>
                                                    <h4>Price</h4>
                                                    <h5>Rs <?php echo e(intval($details['product_price'])); ?></h5>
                                                </div>
                                            </div>
                                            <div class="col-3 order_detail">
                                                <div>
                                                    <h4>Total</h4>
                                                    <h5>Rs <?php echo e(intval($details['total_price'])); ?></h5>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="total-sec">
                            <ul>
                                ...
                                <li>Subtotal <span>Rs <?php echo e($order_info->total); ?></span></li>
                                <li>Shipping <span>Rs <?php echo e($order_info->shipping); ?></span></li>
                                <li>Tax(GST) <span>Rs <?php echo e($order_info->gst_charge); ?></span></li>
                                <li>Discount <span>Rs <?php echo e($order_info->discount); ?></span></li>
                            </ul>
                        </div>
                        <div class="final-total">
                           
                            
                            <h3>Total <span>Rs <?php echo e($order_info->grandtotal); ?></span></h3>
                        </div>
                    </div>
                </div>
                    <?php
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <ul class="order-detail">
                                    ...
                                    <li>Order Date: <?php echo e(date('d M Y',strtotime($order_info->order_date))); ?></li>
                                    <li>Order Total: Rs <?php echo e($order_info->grandtotal); ?>
                            ...
                            <div class="col-sm-6">
                                ...
                                <ul class="order-detail">
                                    <li>Name:<?php echo e($order_info->firstname); ?><?php echo e($order_info->lastname); ?></li>
                                    <li>Address: <?php echo e($order_info->address); ?></li>
                                    <li>Town:<?php echo e($order_info->town); ?></li>
                                    
                                    <li>State:<?php echo e($order_info->state); ?></li>
                                    <li>Country:<?php echo e($order_info->country); ?></li>
                                    <li>Contact No:<?php echo e($order_info->phone); ?></li>
                                </ul>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="delivery-sec">
                                    <h3>Expected Date of Delivery: <span><?php echo e(date('d M Y',strtotime($order_info->order_date. " +7 days"))); ?> </span></h3>
...
<?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/website/front-end/order-success.blade.php ENDPATH**/ ?>