                ...
                <div class="col-sm-9">
                    <div class="card">
                        <div class="card-body">
							...
							<?php endif; ?>
                            <form id="frmOffer" name="frmOffer" class="needs-validation" method="POST" action="<?php echo e(route('vendoroffer.main.update', $offer->id)); ?>">
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\skap\oxygen-new\resources\views/layout/vendor/offer/offers-edit.blade.php ENDPATH**/ ?>