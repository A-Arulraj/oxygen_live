...
<?php $__env->startSection('contents'); ?>
    ...
    <div class="page-body-wrapper">
        ...
        <div class="page-body text-secondary fcolor">
            <form action="<?php echo e(route('vendorproducts.crud.update',$product->id)); ?>" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <select class="custom-select form-control text-secondary"
                                                            ...
                                                            <option><?php echo e($product->tax_id); ?></option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <select class="custom-select form-control dropdown text-secondary"
                                                            id="gst1" onchange="r()" required name="gst_id" required>
                                                                ...
                                                                <option><?php echo e($product->gst_id); ?></option>
                                                            
                                                        </select>
                                                    </div>
                                                </div>
                                                <?php echo $__env->make('layout.vendor.products.producteditDetails', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                                ...
                                                                <div class="conatiner">
                                                                    ...
                                                                    <table class="table table-bordered ">
                                                                        ...
                                                                        <tbody class="spectable">    
                                                                            ...
                                                                            <?php $__currentLoopData = $productspecs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prspec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                
                                                                            <tr>
                                                                                <!--<td>-->
                                                                                <!--     <select type="readonly"  class="js-select2 form-control" name="speci_value[]" value="<?php echo e($prspec->specify_attribute); ?>"-->
                                                                                <!--    id="speci_value">-->
                                                                                <!-- <option value="<?php echo e($prspec->id); ?>"><?php echo e($prspec->name); ?></option>-->
                                                                                <!--</select>                                                                               -->
                                                                                <!--</td>-->
                                                                                <td>
                                                                                     <select type="readonly"  class="js-select2 form-control" name="speci_attri[]"
                                                                                id="speci_attri">
                                                                                 <option value="<?php echo e($prspec->specify_attribute); ?>"><?php echo e($prspec->specify_attribute); ?></option>
                                                                                </select>                                                                               
                                                                                </td>
                                                                                <td>
                                                                                     
                                                                                <select class="js-select2 form-control"  name="speci_value[]" id="speci_value[]">
                                                                                    ...
                                                                                    <?php $__currentLoopData = $spec; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specify_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                        <?php
                                                                                        if($specifi[$i]->name ==$prspec->specify_attribute){
                                                                                        ?>
                                                                                            <option value="<?php echo e($specify_value); ?>" <?php echo e(($specify_value == $prspec->specify_value)?'selected':''); ?>>
                                                                                            <?php echo e($specify_value); ?> </option >
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/vendor/products/EditProduct.blade.php ENDPATH**/ ?>