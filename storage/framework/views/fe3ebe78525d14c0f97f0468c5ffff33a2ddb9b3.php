                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body order-datatable">
                                ...
                                <br>
                                <form action="<?php echo e(route('adminsearchdetails')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                          ...
                                          <div class="col-md-3" style="margin-top:35px;">
                                                ...
                                                <button class="btn btn-primary" type="submit" name ="submit">Search</button>
                                                 <a href="<?php echo e(route('attribute.master.index')); ?>"class="btn btn-primary" type="submit" name ="submit">clear</a>
                                          </div>
                                ...
                                <table class="table fcolor" id="table" data-click-to-select="true" data-sort-name="id"
                                    ...
                                    <tbody id ="tbody">
                                        ...
                                        <?php $spc++; ?>
                                            <tr>
                                                <td><?php echo e(str_pad($loop->iteration, 4, '0', STR_PAD_LEFT)); ?></td>


                                                <td><?php echo e($attribute->category_sub_name); ?></td>
                                                ...
                                                <td>
                                                    <span class="d-flex">
                                                    <button type="button" class="edit_attribute btn btn-secondary mx-1" data-bs-toggle="modal" data-original-title="Edit" value="<?php echo e($attribute->id); ?>" id="edit_attribute">
                                                        <i class="fa fa-pencil"></i> </button>
                                                    
                                                	<form action="<?php echo e(route('attribute.master.destroy', $attribute->id)); ?>"
																method="post">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="" method="post" action="<?php echo e(route('attribute.master.store')); ?>"
                        ...
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="form">
                                ...
                                <div class="form-group">
                                            ...
                                            <div id="clothing">
                                                <select class="js-select2 form-control" name="editsscategory"
                                                    ...
                                                    <option value="">Select Main
                                                        ...
                                                        <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option id="<?php echo e($category1->id); ?>"
                                                            value="<?php echo e($category1->id); ?>">
                                                            <?php echo e($category1->category_name); ?>
                                    ...
                                    <?php $__currentLoopData = $subcategory1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($subcategory->id); ?>">
                                            <?php echo e($subcategory->category_sub_name); ?>
...
/*Category Details*/
    ...
    //         let url = '<?php echo e(route('catedetails')); ?>?sub_category_id=' + sub_category_id;
    //         let method = 'GET';
    //         $("#cate1").html('');
    //         getAjaxValue(url, method, function(data) {
    //             if(data.catedetails)
...
/*Edit Attripute*/ 
    ...
    $.ajax({
        //   data: $('').serialize(),  <?php echo e(url('admin/pincode1')); ?>/"+pin_id+"/edit"
          url: "<?php echo e(url('admin/editattribute')); ?>/"+id+"/edit",          
          type: "get",
          dataType: 'json',
    ...
    function showModal() {
        ...
        $(document).on('submit','#UPDATEFORM', function(e){
            ...
            var url ="<?php echo e(route('attributeupdate', ":updatecate_id")); ?>";
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/admin/products/attribute-listing.blade.php ENDPATH**/ ?>