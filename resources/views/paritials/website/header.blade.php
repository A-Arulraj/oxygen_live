                                                                ...
                                                                <div class="link-section">
                                                                    <div class="menu-title">
                                                                        <!--<h5>{{ $submenus->category_name }}</h5>-->
                                                                              <a style="color: #35bbdb;" href="{{ url( 'Categoryproductshow/'.$submenus->id ) }}">{{ $submenus->category_name }}</a>
                                                                    </div>
                                                                    <div class="menu-content">
                                                                        <ul>
                                                                        @foreach($submenus->childmenu as $childmenus)
                                                                            <li style="text-indent: 2em;"><a style="color: #21bc8d;" href="{{ url( 'Subcategoryproductshow/'.$childmenus->id ) }}">{{ $childmenus->category_sub_name }}</a>
                                                                            </li>
                                                                        @endforeach 
                                                                        </ul>
                                                                    </div>
