							...
							<div id="mySidenav" class="sidenav">
                                    ...
                                    <nav>
                                        ...
                                        <ul id="sub-menu" class="sm pixelstrap sm-vertical">
                                            ...
                                            <li>
                                                <a href="#"><?php echo e($categoriesmain->category_main_name); ?></a>
                                                            ...
                                                            <div class="col-xl-4">
                                                                ...
                                                                <div class="link-section">
                                                                    <?php
                                                                        ...
                                                                        ?>
                                                                        <?php if($category[$i]->main_category_id == $categoriesmain->id): ?>
                                                                       
                                                                            <h5><?php echo e($category[$i]->category_name); ?></h5>

                                                                            <ul>
                                                                                <?php
                                                                                $categorysubcount = count($categorysub);
                                                                                for($j=0; $j< $categorysubcount; $j++){
                                                                                    ?>
                                                                                    <?php if($categorysub[$j]->category_id == $category[$i]->id): ?>

                                                                                    <li><a href="<?php echo e(route('productshow1',['userlogin_id' => $userlogin_id,'categorysub'=> $categorysub[$j]->category_id ] )); ?>"><?php echo e($categorysub[$j]->category_sub_name); ?></a></li>
                                ...
                                <div class="brand-logo">
                                    <a href="index.php"> <img src="<?php echo e(url('frontend_assets/img/logo/logo.png')); ?>"
            ...
            <div class="row margin-default ratio_square">
                <div class="col-xl-1 p-0 col-sm-1 col-3">
                    <a href="#">
                        <div class="img-category">
                            <div class="img-sec">
                                <img  src="../frontend_assets/icons/men.jpg"class="img-fluid bg-img" alt="">
                            </div>
                            <h6>Men</h6>
                        </div>
                    </a>
                  ...
                  <div class="col-xl-1 p-0 col-sm-1 col-3">
                    <a href="#">
                        <div class="img-category">
                            <div class="img-sec">
                                <img src="../frontend_assets/icons/women.jpg" class="img-fluid bg-img" alt="">
                            </div>
                            <h6>Women</h6>
                        </div>
                    </a>
                    ...
                    <a href="#">
                        <div class="img-category">
                            <div class="img-sec">
                                <img src="../frontend_assets/icons/kids.jpg" class="img-fluid bg-img" alt="">
                            </div>
                            <h6>Kids</h6>
                        </div>
                    </a>
                    ...
                    <a href="#">
                        <div class="img-category">
                            <div class="img-sec">
                                <img src="../frontend_assets/icons/jewellery.jpg" class="img-fluid bg-img" alt="">
                            </div>
                            <h6>Jewllery</h6>
                        </div>
                    </a>
			 ...
			 <div class="col-xl-1 p-0 col-sm-1 col-3">
                    <a href="#">
                        <div class="img-category">
                            <div class="img-sec">
                                <img src="../frontend_assets/icons/accessories.jpg" class="img-fluid bg-img" alt="">
                            </div>
                            <h6>Accessories</h6>
                        </div>
                    </a>
				...
				<div class="col-xl-1 p-0 col-sm-1 col-3">
                    <a href="#">
                        <div class="img-category">
                            <div class="img-sec">
                                <img src="../frontend_assets/icons/electronics.jpg" class="img-fluid bg-img" alt="">
                            </div>
                            <h6>Electronics</h6>
                        </div>
                    </a>
				 ...
				 <div class="col-xl-1 p-0 col-sm-1 col-3">
                    <a href="#">
                        <div class="img-category">
                            <div class="img-sec">
                                <img src="../frontend_assets/icons/beauty.jpg" class="img-fluid bg-img" alt="">
                            </div>
                            <h6>Beauty</h6>
                        </div>
                    </a>
				...
				<div class="col-xl-1 p-0 col-sm-1 col-3">
                    <a href="#">
                        <div class="img-category">
                            <div class="img-sec">
                                <img src="../frontend_assets/icons/bags.jpg" class="img-fluid bg-img" alt="">
                            </div>
                            <h6>Bag</h6>
                        </div>
                    </a>
				...
				<div class="col-xl-1 p-0 col-sm-1 col-3">
                    <a href="#">
                        <div class="img-category">
                            <div class="img-sec">
                                <img src="../frontend_assets/icons/sports.jpg" class="img-fluid bg-img" alt="">
                            </div>
                            <h6>Sports</h6>
                        </div>
                    </a>
				 ...
				 <div class="col-xl-1 p-0 col-sm-1 col-3">
                    <a href="#">
                        <div class="img-category">
                            <div class="img-sec">
                                <img src="../frontend_assets/icons/books.jpg" class="img-fluid bg-img" alt="">
                            </div>
                            <h6>Books</h6>
                        </div>
                    </a>
				...
				<div class="col-xl-1 p-0 col-sm-1 col-3">
                    <a href="#">
                        <div class="img-category">
                            <div class="img-sec">
                                <img src="../frontend_assets/icons/footwear.jpg" class="img-fluid bg-img" alt="">
                            </div>
                            <h6>Footwear</h6>
                        </div>
                    </a>
				...
				<div class="col-xl-1 p-0 col-sm-1 col-3">
                    <a href="#">
                        <div class="img-category">
                            <div class="img-sec">
                                <img src="../frontend_assets/icons/appliances.jpg" class="img-fluid bg-img" alt="">
                            </div>
                            <h6>Appliances</h6>
                        </div>
                    </a>
        ...
        <div class="slider-animate home-slider">
            <div>
                <div class="home height-apply p-bottom">
                    <img src="../frontend_assets/img/banner/1.jpg" alt="" class="bg-img  lazyload">
            ...
            <div>
                <div class="home height-apply p-bottom">
                    <img src="../frontend_assets/img/banner/2.jpg" alt="" class="bg-img  lazyload">
                    <div class="container-lg">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain height-apply">
            ...
            <div class="row game-product grid-products px-5">
                ...
                <div class="product-box col-xl-2 col-lg-3 col-sm-4 col-6">
                    <div class="img-wrapper">
                        <div class="front">
                            <a href="<?php echo e(url('useraddtocart1.index', $products->id)); ?>"><img src="<?php echo e(asset('assets/images/products') . '/' . $products->product_image); ?>"
                    ...
                    <div class="product-detail">
                        ...
                        <a href="<?php echo e(url('useraddtocart1.index',$products->id)); ?>">
                            <h6><?php echo e($products->product_name); ?></h6>
                        </a>
            ...
            <div class="row partition3">
                <div class="col-md-4">
                    <a href="#">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="../frontend_assets/img/banner/3.jpg"
                ...
                <div class="col-md-4">
                    <a href="#">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="../frontend_assets/img/banner/2.jpg"
                                    class="img-fluid  lazyload bg-img" alt="">
                            </div>
                            <div class="contain-banner banner-3">
                                <div>
                ...
                <div class="col-md-4">
                    <a href="#">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="../frontend_assets/img/banner/4.jpg"
                                    class="img-fluid  lazyload bg-img" alt="">
                            </div>
                            <div class="contain-banner banner-3">
                                <div>
                                ...
                                <div class="no-slider row five-product">
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <a href="product_view.php"><img
                                                    src="../frontend_assets/img/product/saree/1.jpg"
                                                    class="img-fluid  lazyload bg-img" alt=""></a>
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            ...
                                            <a href="product_view.php"><img
                                                    src="../frontend_assets/img/product/saree/2.jpg"
                                                    class="img-fluid  lazyload bg-img" alt=""></a>
                                            <div class="cart-box cart-box-bottom">
                                                <button data-bs-toggle="modal" data-bs-target="#addtocart"
                                                    title="Add to cart"><i class="ti-shopping-cart"></i></button> <a
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <a href="product_view.php"><img
                                                    src="../frontend_assets/img/product/saree/3.jpg"
                                                    class="img-fluid  lazyload bg-img" alt=""></a>
                                            <div class="cart-box cart-box-bottom">
                                                <button data-bs-toggle="modal" data-bs-target="#addtocart"
                                                    title="Add to cart"><i class="ti-shopping-cart"></i></button> <a
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <div class="lable-block"><span class="lable-gradient">new</span> <span
                                                    class="lable4">on sale</span></div>
                                            <a href="product_view.php"><img
                                                    src="../frontend_assets/img/product/saree/4.jpg"
                                                    class="img-fluid  lazyload bg-img" alt=""></a>
                                            <div class="cart-box cart-box-bottom">
                                                <button data-bs-toggle="modal" data-bs-target="#addtocart"
                                                    title="Add to cart"><i class="ti-shopping-cart"></i></button> <a
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <div class="lable-block"><span class="lable-gradient">new</span> <span
                                                    class="lable4">on sale</span></div>
                                            <a href="product_view.php"><img
                                                    src="../frontend_assets/img/product/saree/5.jpg"
                                                    class="img-fluid  lazyload bg-img" alt=""></a>
                                            <div class="cart-box cart-box-bottom">
                                                <button data-bs-toggle="modal" data-bs-target="#addtocart"
                                                    title="Add to cart"><i class="ti-shopping-cart"></i></button> <a
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <a href="product_view.php"><img
                                                    src="../frontend_assets/img/product/saree/6.jpg"
                                                    class="img-fluid  lazyload bg-img" alt=""></a>
                                            <div class="cart-box cart-box-bottom">
                                                <button data-bs-toggle="modal" data-bs-target="#addtocart"
                                                    title="Add to cart"><i class="ti-shopping-cart"></i></button> <a
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <div class="lable-block"><span class="lable-gradient">new</span> <span
                                                    class="lable4">on sale</span></div>
                                            <a href="product_view.php"><img
                                                    src="../frontend_assets/img/product/saree/7.jpg"
                                                    class="img-fluid  lazyload bg-img" alt=""></a>
                                            <div class="cart-box cart-box-bottom">
                                                <button data-bs-toggle="modal" data-bs-target="#addtocart"
                                                    title="Add to cart"><i class="ti-shopping-cart"></i></button> <a
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <a href="product_view.php"><img
                                                    src="../frontend_assets/img/product/saree/8.jpg"
                                                    class="img-fluid  lazyload bg-img" alt=""></a>
                                            <div class="cart-box cart-box-bottom">
                                                <button data-bs-toggle="modal" data-bs-target="#addtocart"
                                                    title="Add to cart"><i class="ti-shopping-cart"></i></button> <a
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <div class="lable-block"><span class="lable-gradient">new</span> <span
                                                    class="lable4">on sale</span></div>
                                            <a href="product_view.php"><img
                                                    src="../frontend_assets/img/product/saree/11.jpg"
                                                    class="img-fluid  lazyload bg-img" alt=""></a>
                                            <div class="cart-box cart-box-bottom">
                                                <button data-bs-toggle="modal" data-bs-target="#addtocart"
                                                    title="Add to cart"><i class="ti-shopping-cart"></i></button> <a
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <a href="product_view.php"><img
                                                    src="../frontend_assets/img/product/saree/10.jpg"
                                                    class="img-fluid  lazyload bg-img" alt=""></a>
                                            <div class="cart-box cart-box-bottom">
                                                <button data-bs-toggle="modal" data-bs-target="#addtocart"
                                                    title="Add to cart"><i class="ti-shopping-cart"></i></button> <a
                                ...
                                <div class="no-slider row">
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            ...
                                            <div class="front">
                                                <a href="product_view.php"><img
                                                        src="../frontend_assets/images/pro3/33.jpg"
                                                        class="img-fluid  lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="product_view.php"><img
                                                        src="../frontend_assets/images/pro3/34.jpg"
                                                        class="img-fluid  lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-box cart-box-bottom">
                                                <button data-bs-toggle="modal" data-bs-target="#addtocart"
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product_view.php"><img
                                                        src="../frontend_assets/images/pro3/35.jpg"
                                                        class="img-fluid  lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="product_view.php"><img
                                                        src="../frontend_assets/images/pro3/36.jpg"
                                                        class="img-fluid  lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <button data-bs-toggle="modal" data-bs-target="#addtocart"
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            ...
                                            <div class="front">
                                                <a href="product_view.php"><img
                                                        src="../frontend_assets/images/pro3/1.jpg"
                                                        class="img-fluid  lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="product_view.php"><img
                                                        src="../frontend_assets/images/pro3/2.jpg"
                                                        class="img-fluid  lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <button data-bs-toggle="modal" data-bs-target="#addtocart"
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product_view.php"><img
                                                        src="../frontend_assets/images/pro3/27.jpg"
                                                        class="img-fluid  lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="product_view.php"><img
                                                        src="../frontend_assets/images/pro3/28.jpg"
                                                        class="img-fluid  lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <button data-bs-toggle="modal" data-bs-target="#addtocart"
 ...
 <div class="title1 title-fancy section-t-space">
    ...
    <section class="pt-0 section-b-space ratio_asos">
        <div class="container-fuild">
            <div class="row game-product grid-products px-5">
                ...
                <div class="product-box col-xl-2 col-lg-2 col-sm-4 col-6">
                    <div class="img-wrapper auction-panel">
                        <div class="front">
                            <a href="product_view.php"><img src="../frontend_assets/img/product/top/3/1.jpg"
                                    class="img-fluid  lazyload bg-img" alt=""></a>
                        </div>
                       ...
                       <h5>Starting  <span>Rs.599</span></h5>
					   <div class="btn auction-btn btn-lg pt-2" data-bs-toggle="modal" data-bs-target="#addtocart">Bid Now</div><br><br>
					   <div><p  style="font-size:20px;border-color:#009ffd;"id="demo"></p>
                ...
                <div class="product-box col-xl-2 col-lg-2 col-sm-4 col-6">
                    <div class="img-wrapper auction-panel">
                        ...
                        <div class="front">
                            <a href="product_view.php"><img src="../frontend_assets/img/product/saree/8.jpg"
                                    class="img-fluid  lazyload bg-img" alt=""></a>
                        </div>
                                                <div class="product-detail">
                       ...
                       <h5>Starting  <span>Rs.599</span></h5>
					   <div class="btn auction-btn btn-lg pt-2" data-bs-toggle="modal" data-bs-target="#addtocart">Bid Now</div><br><br>
					   <div><p  style="font-size:20px;border-color:#009ffd;"id="demo1"></p>
					   <p style="font-size:15px; font-weight:bold;margin-left: -10px;">Days  &nbsp  Hrs  &nbsp    Min &nbsp    Sec</p>
					   </div>
                    </div>
                    </div>
             ...
             <div class="product-box col-xl-2 col-lg-2 col-sm-4 col-6">
                    <div class="img-wrapper auction-panel">
                        <div class="lable-block"><span class="lable4">on sale</span></div>
                        <div class="front">
                            <a href="product_view.php"><img src="../frontend_assets/img/product/top/2/1.jpg"
                                    class="img-fluid  lazyload bg-img" alt=""></a>
                        </div>
                                                <div class="product-detail">
                       ...
                       <h5>Starting  <span>Rs.599</span></h5>
					   <div class="btn auction-btn btn-lg pt-2" data-bs-toggle="modal" data-bs-target="#addtocart">Bid Now</div><br><br>
					   <div><p  style="font-size:20px;border-color:#009ffd;"id="demo2"></p>
					  <p style="font-size:15px; font-weight:bold;margin-left: -10px;">Days  &nbsp  Hrs  &nbsp    Min &nbsp    Sec</p>
					   </div>
                    </div>
                    </div>
               ...
               <div class="product-box col-xl-2 col-lg-2 col-sm-4 col-6">
                    <div class="img-wrapper auction-panel">
                        <div class="lable-block"><span class="lable4">on sale</span></div>
                        <div class="front">
                            <a href="product_view.php"><img src="../frontend_assets/img/product/saree/4.jpg"
                                    class="img-fluid  lazyload bg-img" alt=""></a>
                        </div>
                                                <div class="product-detail">
                       ...
                       <h5>Starting  <span>Rs.599</span></h5>
					   <div class="btn auction-btn btn-lg pt-2" data-bs-toggle="modal" data-bs-target="#addtocart">Bid Now</div><br><br>
					   <div><p  style="font-size:20px;border-color:#009ffd;"id="demo3"></p>
					 <p style="font-size:15px; font-weight:bold;margin-left: -10px;">Days  &nbsp  Hrs  &nbsp    Min &nbsp    Sec</p>
					   </div>
                    </div>
                    </div>
				...
				<div class="product-box col-xl-2 col-lg-2 col-sm-4 col-6">
                    <div class="img-wrapper auction-panel">
                        <div class="lable-block"><span class="lable4">on sale</span></div>
                        <div class="front">
                            <a href="product_view.php"><img src="../frontend_assets/img/product/top/4/1.jpg"
                                    class="img-fluid  lazyload bg-img" alt=""></a>
                        </div>
                                                <div class="product-detail">
                       ...
                       <h5>Starting  <span>Rs.599</span></h5>
					   <div class="btn auction-btn btn-lg pt-2" data-bs-toggle="modal" data-bs-target="#addtocart">Bid Now</div><br><br>
												<div><p  style="font-size:20px;border-color:#009ffd;"id="demo4"></p>
					<p style="font-size:15px; font-weight:bold;margin-left: -10px;">Days  &nbsp  Hrs  &nbsp    Min &nbsp    Sec</p></div>
                    </div>
                    </div>
				...
				<div class="product-box col-xl-2 col-lg-2 col-sm-4 col-6">
                    <div class="img-wrapper auction-panel">
                        <div class="lable-block"><span class="lable4">on sale</span></div>
                        <div class="front">
                            <a href=""><img src="../frontend_assets/img/product/saree/7.jpg"
                                    class="img-fluid  lazyload bg-img" alt=""></a>
                        </div>
                                                <div class="product-detail">
                       ...
                       <h5>Starting  <span>Rs.599</span></h5>
					   <div class="btn auction-btn btn-lg pt-2" data-bs-toggle="modal" data-bs-target="#addtocart">Bid Now</div><br><br>
					   <div><p  style="font-size:20px;border-color:#009ffd;"id="demo5"></p>
					  <p style="font-size:15px; font-weight:bold;margin-left: -10px;">Days  &nbsp  Hrs  &nbsp    Min &nbsp    Sec</p></div>
                    </div>
                    </div>
	...
	<div class="container">
        <div class="slider-animate home-slider">
            <div>
                <div class="home height-apply p-bottom">
                    <img src="../frontend_assets/img/banner/adv/1.jpg" alt="" class="bg-img  lazyload">
                    <div class="container-lg">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain height-apply">
            ...
            <div>
                <div class="home height-apply p-bottom">
                    <img src="../frontend_assets/img/banner/adv/2.jpg" alt="" class="bg-img  lazyload">
                    <div class="container-lg">
		...
		<div>
                <div class="home height-apply p-bottom">
                    <img src="../frontend_assets/img/banner/adv/3.jpg" alt="" class="bg-img  lazyload">
                    <div class="container-lg">
        ...
        <div class="container-lg container">
            <div class="row margin-default ratio_square ">
                <div class="col-xl-2 col-md-3 col-sm-4 col-4">
                    <a href="#">
                        <div class="deal-category">
                            <img src="../frontend_assets/images/gradient/deal-bg/1.jpg" class="img-fluid w-100" alt="">
                ...
                <div class="col-xl-2 col-md-3 col-sm-4 col-4">
                    <a href="#">
                        <div class="deal-category">
                            <img src="../frontend_assets/images/gradient/deal-bg/2.jpg" class="img-fluid w-100" alt="">
                            <div class="deal-content">
                                <div>
                                    <h2>Flat</h2>
                                    <h2>60%</h2>
                ...
                <div class="col-xl-2 col-md-3 col-sm-4 col-4">
                    <a href="#">
                        <div class="deal-category">
                            <img src="../frontend_assets/images/gradient/deal-bg/6.jpg" class="img-fluid w-100" alt="">
                            <div class="deal-content">
                                <div>
                                    <h2>free</h2>
                                    <h2>Ship.</h2>
                ...
                <div class="col-xl-2 col-md-3 col-sm-4 col-4">
                    <a href="#">
                        <div class="deal-category">
                            <img src="../frontend_assets/images/gradient/deal-bg/3.jpg" class="img-fluid w-100" alt="">
                            <div class="deal-content">
                                <div>
                                    <h2>Buy 1</h2>
                                    <h2>Get 1</h2>
                ...
                <div class="col-xl-2 col-md-3 col-sm-4 col-4">
                    <a href="#">
                        <div class="deal-category">
                            <img src="../frontend_assets/images/gradient/deal-bg/4.jpg" class="img-fluid w-100" alt="">
                            <div class="deal-content">
                                <div>
                                    <h2>upto</h2>
                                    <h2>40%</h2>
                ...
                <div class="col-xl-2 col-md-3 col-sm-4 col-4">
                    <a href="#">
                        <div class="deal-category">
                            <img src="../frontend_assets/images/gradient/deal-bg/5.jpg" class="img-fluid w-100" alt="">
                            <div class="deal-content">
                                <div>
                                    <h2>Min</h2>
                                    <h2>20%</h2>
                    ...
                    <a href="#">
                        <div class="gradient-category">
                            <div class="gradient-border">
                                <div class="img-sec">
                                    <img src="../frontend_assets/images/fashion/category/1.png" class="img-fluid" alt="">
                                </div>
                            </div>
                            <h4>Top wear</h4>
                        </div>
                ...
                <div class="col-xl-2 col-md-3 col-sm-4 col-6">
                    <a href="#">
                        <div class="gradient-category hover-effect">
                            <div class="gradient-border">
                                <div class="img-sec">
                                    <img src="../frontend_assets/images/fashion/category/4.png" class="img-fluid" alt="">
                                </div>
                            </div>
                            <h4>dresses</h4>
                        </div>
                ...
                <div class="col-xl-2 col-md-3 col-sm-4 col-6">
                    <a href="#">
                        <div class="gradient-category">
                            <div class="gradient-border">
                                <div class="img-sec">
                                    <img src="../frontend_assets/images/fashion/category/3.png" class="img-fluid" alt="">
                                </div>
                            </div>
                            <h4>bottom</h4>
                        </div>
                ...
                <div class="col-xl-2 col-md-3 col-sm-4 col-6">
                    <a href="#">
                        <div class="gradient-category">
                            <div class="gradient-border">
                                <div class="img-sec">
                                    <img src="../frontend_assets/images/fashion/category/2.png" class="img-fluid" alt="">
                                </div>
                            </div>
                            <h4>inner/sleep</h4>
                        </div>
                ...
                <div class="col-xl-2 col-md-3 col-sm-4 col-6">
                    <a href="#">
                        <div class="gradient-category">
                            <div class="gradient-border">
                                <div class="img-sec">
                                    <img src="../frontend_assets/images/fashion/category/5.png" class="img-fluid" alt="">
                                </div>
                            </div>
                            <h4>footwear</h4>
                        </div>
                ...
                <div class="col-xl-2 col-md-3 col-sm-4 col-6">
                    <a href="#">
                        <div class="gradient-category">
                            <div class="gradient-border">
                                <div class="img-sec">
                                    <img src="../frontend_assets/images/fashion/category/6.png" class="img-fluid" alt="">
                                </div>
                            </div>
                            <h4>sports/active</h4>
                        </div>
                    ...
                    <a href="#">
                        <div class="img-category">
                            <div class="pattern-bg bg1">
                                <div class="img-sec">
                                    <img src="../frontend_assets/images/fashion/category/8.png" class="img-fluid bg-img" alt="">
                                </div>
                            </div>
                            <h4>Top wear</h4>
                        </div>
                    ...
                    <a href="#">
                        <div class="img-category hover-effect">
                            <div class="pattern-bg bg2">
                                <div class="img-sec">
                                    <img src="../frontend_assets/images/fashion/category/9.png" class="img-fluid bg-img" alt="">
                                </div>
                            </div>
                            <h4>dresses</h4>
                        </div>
                    ...
                    <a href="#">
                        <div class="img-category">
                            <div class="pattern-bg bg3">
                                <div class="img-sec">
                                    <img src="../frontend_assets/images/fashion/category/10.png" class="img-fluid bg-img" alt="">
                                </div>
                            </div>
                            <h4>bottom</h4>
                        </div>
                    ...
                    <a href="#">
                        <div class="img-category">
                            <div class="pattern-bg bg4">
                                <div class="img-sec">
                                    <img src="../frontend_assets/images/fashion/category/11.png" class="img-fluid bg-img" alt="">
                                </div>
                            </div>
                            <h4>inner/sleep</h4>
                        </div>
                    ...
                    <a href="#">
                        <div class="img-category">
                            <div class="pattern-bg bg5">
                                <div class="img-sec">
                                    <img src="../frontend_assets/images/fashion/category/12.png" class="img-fluid bg-img" alt="">
                                </div>
                            </div>
                            <h4>footwear</h4>
                        </div>
                    ...
                    <a href="#">
                        <div class="img-category">
                            <div class="pattern-bg bg6">
                                <div class="img-sec">
                                    <img src="../frontend_assets/images/fashion/category/13.png" class="img-fluid bg-img" alt="">
                                </div>
                            </div>
                            <h4>sports/active</h4>
                        </div>
            ...
            <div class="row partition2">
                ...
                <div class="col-md-6">
                    <a href="#">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part">
                                <img src="../frontend_assets/img/banner/1.jpg"
                                    class="img-fluid  lazyload bg-img" alt="">
                            </div>
                            <div class="contain-banner">
                                <div>
                            ...
                            <div id="tab-4" class="tab-content active default">
                                <div class="no-slider row five-product">
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <div class="lable-block"><span class="lable-gradient">new</span> <span
                                                    class="lable4">on sale</span></div>
                                            <a href="product_view.php"><img
                                                    src="../frontend_assets/img/product/top/1/1.jpg"
                                                    class="img-fluid  lazyload bg-img" alt=""></a>
                                            <div class="cart-box cart-box-bottom">
                                                <button data-bs-toggle="modal" data-bs-target="#addtocart"
                                                    title="Add to cart"><i class="ti-shopping-cart"></i></button> <a
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <a href="product_view.php"><img
                                                    src="../frontend_assets/img/product/top/2/1.jpg"
                                                    class="img-fluid  lazyload bg-img" alt=""></a>
                                            <div class="cart-box cart-box-bottom">
                                                <button data-bs-toggle="modal" data-bs-target="#addtocart"
                                                    title="Add to cart"><i class="ti-shopping-cart"></i></button> <a
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <div class="lable-block"><span class="lable-gradient">new</span> <span
                                                    class="lable4">on sale</span></div>
                                            <a href="product_view.php"><img
                                                    src="../frontend_assets/img/product/top/3/1.jpg"
                                                    class="img-fluid  lazyload bg-img" alt=""></a>
                                            <div class="cart-box cart-box-bottom">
                                                <button data-bs-toggle="modal" data-bs-target="#addtocart"
                                                    title="Add to cart"><i class="ti-shopping-cart"></i></button> <a
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <a href="product_view.php"><img
                                                    src="../frontend_assets/img/product/top/4/1.jpg"
                                                    class="img-fluid  lazyload bg-img" alt=""></a>
                                            <div class="cart-box cart-box-bottom">
                                                <button data-bs-toggle="modal" data-bs-target="#addtocart"
                                                    title="Add to cart"><i class="ti-shopping-cart"></i></button> <a
                ...
                <div class="row footer-theme partition-f">
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="footer-contant">
                            <div class="footer-logo"><img src="../frontend_assets/img/logo/logo.png" alt=""></div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6 col-sm-12">
                        <div class="payment-card-bottom">
                            <ul>
                                <li>
                                    <a href="#"><img src="../frontend_assets/images/icon/visa.png" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="../frontend_assets/images/icon/mastercard.png" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="../frontend_assets/images/icon/paypal.png" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="../frontend_assets/images/icon/american-express.png" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="../frontend_assets/images/icon/discover.png" alt=""></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xs-12">
                            <div class="quick-view-img"><img src="../frontend_assets/images/pro3/1.jpg" alt=""
            ...
            <div class="setting_box_body">
                ...
                <div class="setting-body">
                    <div class="setting-title">
                        <div>
                            <img src="../frontend_assets/images/icon/logo.png" class="img-fluid" alt="">
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="gradient.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/gradient.jpg"
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="index.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/fashion.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="fashion-2.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/fashion-2.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="fashion-3.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/fashion-3.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="fashion-4.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/fashion-4.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="fashion-5.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/fashion-5.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="fashion-6.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/fashion-6.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="fashion-7.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/fashion-7.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="furniture.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/furniture.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="furniture-2.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/furniture-2.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="furniture-3.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/furniture-dark.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="electronic-1.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/electronics.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="electronic-2.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/electronics-2.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="electronic-3.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/electronics-3.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="marketplace-demo.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/marketplace.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="marketplace-demo-2.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/marketplace-2.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="marketplace-demo-3.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/marketplace-3.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="marketplace-demo-4.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/marketplace-4.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="vegetables.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/vegetables.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="vegetables-2.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/vegetables-2.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="vegetables-3.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/vegetables-3.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="jewellery.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/jewellery.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="jewellery-2.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/jewellery-2.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="jewellery-3.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/jewellery-3.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="bags.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/bag.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="watch.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/watch.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="medical.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/medical.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="perfume.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/perfume.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="yoga.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/yoga.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="christmas.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/christmas.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="bicycle.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/bicycle.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="marijuana.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/marijuana.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="gym-product.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/gym.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="tools.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/tools.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="shoes.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/shoes.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="books.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/books.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="kids.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/kids.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="game.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/game.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="beauty.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/beauty.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="left_sidebar-demo.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/left-sidebar.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="video-slider.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/video-slider.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="metro.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/metro.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="goggles.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/goggles.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="flower.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/flower.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="light.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/light.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="nursery.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/nursery.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="pets.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/pets.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="video.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/video.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="lookbook-demo.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/lookbook.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="full-page.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/full-page.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="instagram-shop.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/instagram.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
                            ...
                            <div class="col-md-4 col-6 text-center demo-effects">
                                <div class="set-position">
                                    <a href="parallax.html" class="layout-container">
                                        <img src="../frontend_assets/images/landing-page/demo/parallax.jpg"
                                            class="img-fluid bg-img bg-top" alt="">
                                    </a>
...
</html><?php /**PATH F:\mano\oxygen-new\resources\views/website/front-end/index1.blade.php ENDPATH**/ ?>