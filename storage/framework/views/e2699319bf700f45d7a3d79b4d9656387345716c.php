                            ...
                            <div class="card-body">
                                ...
                                <table class="table" id="table" data-click-to-select="true" data-sort-name="id"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                             <td><span><?php echo e($loop->iteration); ?></span></br></td>
                                            <td>
                                                <div class="d-flex">
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/admin/vendor/vendor-list.blade.php ENDPATH**/ ?>