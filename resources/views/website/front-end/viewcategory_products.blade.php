   ...
   @include('paritials.website.header')
	 @if(count($categorys) > 0)
	   <div class="title1 section-t-space pt-5">
        ...
        <h4 class="title-inner1 text-left">{{strtoupper($category->category_name)}} </h4>
    </div>
<div class="row ">
                                    ...
                                    <div class="collection-collapse-block-content">
                                        <div class="collection-brand-filter">
                                            ...
                                            @foreach($categorys as $catelist )
                                                    ...
                                                    <input type="hidden" id="" name="cate1" value="{{$category_id}}">
                                        ...
                                        <div class="collection-brand-filter">
                                            ...
                                            <div class="col-12">
                                                <div class="text-end button_bottom">
                                                    ...
                                                    <a href="{{ url( 'Categoryproductshow/'.$category_id ) }}"
    ...
    <section class="" style="padding-top:90px;">
        <h6 class="title-inner1 text-left">HOME / {{strtoupper($category->category_main_name)}} / {{strtoupper($category->category_name)}} </h6>
        <p><b>{{strtoupper($category->category_name)}} {{count($product)}} items</b></p>
        <div class="container container-lg">
            <div class="row margin-default ratio_square">
				...
				@endforeach
                 <input type="hidden" id="cate_id" name="cate_id" value="{{$category_id}}">
            </div>
        </div>
    </section>
	@endif
                                                                    ...
                                                                    $productdetails = App\Models\Products\ProductsDetails::where('products_id',$products->id)->first();   
                                                                        ...
                                                                        if($products->product_id == $productdetails->products_id)
                                                                        {
                                                                            ?>
                                                                                ...
                                                                                @endphp
                                                                                <h4>Rs.{{ $productdetails->selling_price }} <del>Rs {{ $productdetails->retail_price }}</del><span style="color:red;">({{round($offerperc)}}%Off)</span></h4>
