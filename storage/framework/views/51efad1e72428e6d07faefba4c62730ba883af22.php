    ...
    <div class="page-main-header">
        <div class="main-header-right row p-0">
            <div class="main-header-left d-lg-none w-auto">
                <div class="logo-wrapper"><a href="<?php echo e(url('admin/dashboard')); ?>"><img class="blur-up lazyloaded"
                            src="<?php echo e(asset('assets/images/dashboard/logo/newlogo.png')); ?>" alt=""></a></div>
            </div>
                ...
                <ul class="nav-menus">
                    ...
                    <li class="onhover-dropdown">
                        <div class="media align-items-center"><img
                                ...
                                src="<?php echo e(asset('assets/images/dashboard/logo/fav.png')); ?>" alt="header-user">
                        ...
                        <ul class="profile-dropdown onhover-show-div p-20 profile-dropdown-hover">
                            ...
                            <li><a href="<?php echo e(url('admin/logout')); ?>"><i data-feather="log-out"></i>Logout</a></li>
                        </ul>
                    </li>
                </ul>
...
<?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/paritials/auth/topmenu.blade.php ENDPATH**/ ?>