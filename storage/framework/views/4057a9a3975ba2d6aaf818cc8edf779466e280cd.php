                                ...
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <table class="table" id="table" data-click-to-select="true"
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $pincode; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    
                                                    <td>#<?php echo e($loop->iteration); ?></td>
                                                    <td><?php echo e($pin->zonal_id); ?></td>
                                                    <td><?php echo e($pin->route_id); ?></td>
                                                    
                                                    <td><?php echo e($pin->name); ?></td>
                                                    <td><?php echo e($pin->area); ?></td>
                                                    <td><?php echo e($pin->post_region); ?></td>
                                                    <td>
                                                        <label class="switch">
                                                            <input type="checkbox"
                                                    ...
                                                    <td>
                                                        ...
                                                        <span class="d-flex">
                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <form class="" method="post" action="<?php echo e(route('pincode1.update', $pin->id)); ?>" enctype="multipart/form-data">
                                                                                    <?php echo csrf_field(); ?>
                                                                                    ...
                                                                                    <div class="form">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input class="form-control" id="pincode" name="pincode" value= "<?php echo e($pinc->name); ?>" required="" type="text">
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                            <label for="validationCustom01" class="mb-1">Area</label>
                                                                                            <input class="form-control" id="area" name="area" value= "<?php echo e($pinc->area); ?>" required=""
                                                                                                type="text">
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                            <label for="validationCustom02" class="mb-1">Postal Region
                                                                                                :</label>
                                                                                            <input class="form-control" require="" id="post_regin" name="post_regin" value= "<?php echo e($pinc->post_region); ?>" type="text">
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                            <label for="validationCustom01"
                                                                                                class="mb-1">Status</label>
                                                                                            <select class="custom-select w-100 form-control"
                                                                                                required="" id="status" value= "<?php echo e($pinc->status); ?>" name="status">
                                                            ...
                                                            <form
                                                                action="<?php echo e(route('pincode1.destroy', $pin->id)); ?>"
                                                                method="post">
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\oxygen-new\resources\views/layout/admin/master/pincode1.blade.php ENDPATH**/ ?>