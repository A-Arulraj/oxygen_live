                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                          ...
                          <a href="<?php echo e(url('admin/offer/create?id=1')); ?>" class="btn mb-4 btn-primary"><i class="fa fa-plus"></i> Add Offers </a> 
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\mano\oxygen-new\resources\views/layout/admin/offer/offers-list.blade.php ENDPATH**/ ?>