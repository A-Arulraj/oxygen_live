                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $data->routeList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
													...
													<td><?php echo e($route->zonals->name); ?></td>
                                                    <td>
                                                        <label class="switch">
                                                            <input type="checkbox"
                                                    ...
                                                    <td><span> <a href="#" class="badge badge-secondary px-2"
                                                                ...
                                                                data-bs-target="#edit<?php echo e($route->id); ?>"data-original-title="Edit"><i
                                                                    class="fa fa-pencil"></i> </a>
                                                            <a href="<?php echo e(url('route_delete/'.$route->id)); ?>"
                                                    ...
                                                    <div class="modal fade" id="edit<?php echo e($route->id); ?>" tabindex="-1" role="dialog"
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form class="" action="<?php echo e(url('route_update/'.$route->id)); ?>" id="form" method="post">
                                                                        <div class="form">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label for="validationCustom01" class="mb-1">Route Name
                                                                                    :</label>
                                                                                <input class="form-control" id="name" type="text"
                                                                                    name="name" required="true" value="<?php echo e($route->name); ?>">
                                                                            </div>
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\mano\oxygen-new\resources\views/layout/admin/master/route.blade.php ENDPATH**/ ?>