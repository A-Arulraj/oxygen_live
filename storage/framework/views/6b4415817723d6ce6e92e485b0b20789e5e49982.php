...
<?php $__env->startSection('contents'); ?>
    ...
    <div class="page-body-wrapper">
        ...
        <div class="page-body text-secondary fcolor">
            <form action="<?php echo e(route('products.crud.store')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="col-md-12 digital-add needs-validation">
                                                ...
                                                <?php echo $__env->make('layout.admin.products.productDetails', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                <div class="card">
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/admin/products/add-product.blade.php ENDPATH**/ ?>