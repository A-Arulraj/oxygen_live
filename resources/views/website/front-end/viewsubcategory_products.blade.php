                                                                            ...
                                                                            <div class="collection-brand-filter">
                                                                                ...
                                                                                <div class="col-12">
                                                                                    <div class="text-end button_bottom">
                                                                                        ...
                                                                                        <a href="{{ url( 'Subcategoryproductshow/'.$subcategory_id ) }}"
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="collection-product-wrapper">
                                        <h6 class="title-inner1 text-left">HOME / {{strtoupper($category->category_main_name)}} / {{strtoupper($category->category_name)}} / {{strtoupper($category->category_sub_name)}} </h6>
                                        <p><b>{{strtoupper($category->category_sub_name)}} {{count($product)}} items</b></p>   
