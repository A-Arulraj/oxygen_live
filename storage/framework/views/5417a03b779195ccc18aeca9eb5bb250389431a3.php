                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                          ...
                          <a href="<?php echo e(url('offer/create?id=1')); ?>" class="btn mb-4 btn-primary"><i class="fa fa-plus"></i> Add Offers </a> 
                                        ...
                                        <?php $__currentLoopData = $Offer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><!--span> <a href="#" class="badge badge-secondary px-2"
                                                	 ...
                                                	 <form
																action="<?php echo e(route('offer.main.destroy', $attribute->id)); ?>"
																method="post">
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\oxygen-new\resources\views/layout/admin/offer/offers-list.blade.php ENDPATH**/ ?>