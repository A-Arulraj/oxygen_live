          ...
          <li><a class="sidebar-header" href="<?php echo e(url('dashboard')); ?>"><i
            ...
            <?php if(session()->get('level') == 5 || session()->get('level') == 4): ?>
                <li><a class="sidebar-header" href=""><i data-feather="user-plus"></i><span>Role</span><i
                            class="fa fa-angle-right pull-right"></i></a>
                    <ul class="sidebar-submenu">
                        <li><a href="<?php echo e(url('role/create')); ?>"><i class="fa fa-circle"></i>Role Create </a></li>
                        <li><a href="<?php echo e(url('role/list')); ?>"><i class="fa fa-circle"></i>Role Assign</a></li>
            ...
            <li><a class="sidebar-header" href=""><i data-feather="database"></i><span>Master</span><i
                ...
                <ul class="sidebar-submenu">
                    ...
                    <li><a href="<?php echo e(url('department')); ?>"><i class="fa fa-circle"></i>Department</a></li>
                    <li><a href="<?php echo e(url('designation')); ?>"><i class="fa fa-circle"></i>Designation</a></li>
                    <li><a href="<?php echo e(url('zonal')); ?>"><i class="fa fa-circle"></i>Zonal</a></li>
                    <li><a href="<?php echo e(url('route')); ?>"><i class="fa fa-circle"></i>Route</a></li>
...
<?php /**PATH F:\oxygen-new\resources\views/paritials/auth/sidemenu.blade.php ENDPATH**/ ?>