                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                          ...
                          <a href="<?php echo e(route('offer.main.create')); ?>" class="btn mb-4 btn-primary"><i class="fa fa-plus"></i> Add Offers </a> 
                                        ...
                                        <?php $__currentLoopData = $Offer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><span class="mt-3 d-flex">
                                                    <form action="<?php echo e(route('offer.main.edit', $attribute->id)); ?>"
                                                        method="get">
                                                    ...
                                                    onclick="return confirm('Are you sure, you want to delete it?')"
                                                	 ...
                                                	 <form action="<?php echo e(route('offer.main.destroy', $attribute->id)); ?>"
																method="post">
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/admin/offer/offers-list.blade.php ENDPATH**/ ?>