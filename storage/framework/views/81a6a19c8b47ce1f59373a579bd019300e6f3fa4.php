                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                          ...
                          <a href="<?php echo e(route('staffauction.create')); ?>" class="btn mb-4 btn-primary"><i class="fa fa-plus"></i> Add Offers </a> 
                          <?php if($errors->any()): ?>
                      ...
                      <?php endif; ?>
                                    <div class="card-body">
                                        <form action="<?php echo e(route('staffimport')); ?>"
                                              method="POST"
                    ...
                    <tr>
                        ...
                        <td><span class="mt-3 d-flex">
                            <form action="<?php echo e(route('staffauction.edit', $item->id)); ?>"
                                method="get">
                            ...
                            <form action="<?php echo e(route('staffauction.destroy', $item->id)); ?>"
                                method="post">
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/staff/auction/list-auction.blade.php ENDPATH**/ ?>