...
<?php $__env->startSection('contents'); ?>
    ...
    <div class="page-body-wrapper">
        ...
        <div class="page-body text-secondary fcolor">
            <form action="<?php echo e(route('products.crud.update',$product->id)); ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                                                   ...
                                                                   <!-- <option selected  value="
                                                                      ...
                                                                      <?php $__currentLoopData = $category_main_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category_main): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        ...
                                                                        <option id="<?php echo e($category_main->id); ?>"
                                                                            value="<?php echo e($category_main->id); ?>" <?php echo e(($category_main->id==$product->category_main)?'selected':''); ?> hidden>
                                                            ...
                                                            <div id="clothing">
                                                                <select class="js-select2 form-control" name="category"
                                                                    id="category"  required>
                                                                        ...
                                                                        <option value="<?php echo e($product->category); ?>"> <?php echo e($cates['0']->category_name); ?></option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div id="clothing">
                                                                <select class="js-select2 form-control" name="category_sub"
                                                                    ...
                                                                    <option value="  <?php echo e($product->category_sub); ?>"> <?php echo e($cates['0']->category_sub_name); ?></option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-12 digital-add needs-validation">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="form-group mt-2">
                                                            ...
                                                            <input class="form-control" id="validationCustom01"
                                                                type="text" name="product_name" required value="<?php echo e($product->product_name); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        ...
                                                        <select class="custom-select form-control text-secondary"
                                                            ...
                                                            <option value="1" <?php echo e($product->tax_id == 1 ? 'selected' : ''); ?>>Included</option>
                                                            <option value="0" <?php echo e($product->tax_id == 0 ? 'selected' : ''); ?>>Excluded</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <select class="custom-select form-control dropdown text-secondary"
                                                            id="gst1" onchange="r()" required name="gst_id" required>
                                                                ...
                                                                <option value="<?php echo e($gst->value); ?>" <?php echo e($product->gst_id == $gst->value ? 'selected' : ''); ?>><?php echo e($gst->gst_name); ?>
                                                ...
                                                <?php echo $__env->make('layout.admin.products.producteditDetails', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-2">
                                                                ...
                                                                <img src="<?php echo e(url('assets/images/products/'.$product->product_image)); ?>" id="mainImg" name="mainImage" height="100" width="100">
                                                                <input class="form-control" type="file" id="mainImg" name="mainImage" multiple accept="image/*">
                                                                
                                                                    
                                                                    <input class="form-control" type="hidden" id="mainImage" name="oldmainImage" value="<?php echo e($product->product_image); ?>" multiple accept="image/*">
                                                            </div>
                                                        ...
                                                        <div class="digital-add needs-validation">
                                                            <div class="form-group mb-0">
                                                                <div class="description-sm">
                                                                    <textarea id="description" cols="10" required rows="4" name="description"><?php echo e($product->description); ?></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <div class="next-input--stylized">
                                                                            <input type="number" class="form-control"
                                                                                name="weight" placeholder="Weight (g)" value="<?php echo e($product->weight); ?>">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="form-group mb-3">
                                                                            <div class="next-input--stylized">
                                                                                <input type="number" class="form-control"
                                                                                    name="width" placeholder="Width (cm)" value="<?php echo e($product->width); ?>">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3 ">
                                                                        <div class="form-group mb-3">
                                                                            <div class="next-input--stylized">
                                                                                ...
                                                                                <input type="number" class="form-control"
                                                                                    name="height" placeholder="Height (cm)" value="<?php echo e($product->height); ?>">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <table class="table table-bordered ">
                                                                        ...
                                                                        <tbody class="spectable">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <?php $sp=0; ?>
                                                                                <?php $__currentLoopData = $productspecs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pres): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <?php if($specifi[$i]->id==$pres->spec_id): ?>
                                                                                <?php $sp++; ?>
                                                                                <?php endif; ?>
                                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                                <td> <div class="row">
                                                                                    <div class="col-md-1">
                                                                                        <input type="checkbox" id="spec_id" name="spec_id[]" value="<?php echo e($specifi[$i]->id); ?>" <?php echo e(($sp>0)?'checked':''); ?>>
                                                                                    </div>
                                                                                    <div class="col-md-11">
                                                                                <select   class="form-control"  name="speci_attri[<?php echo e($specifi[$i]->id); ?>]" id="speci_attri">
                                                                               
                                                                                    <option value="<?php echo e($specifi[$i]->name); ?>"><?php echo e($specifi[$i]->name); ?></option>
                                                                                </select> 
                                                                                    </div>
                                                                                 </div>
                                                                                </td>
                                                                                ...
                                                                                <td>
                                                                                        ...
                                                                                        <select class="form-select form-select-lg text-secondary"  name="speci_value[<?php echo e($specifi[$i]->id); ?>]" id="speci_value" id="speci_value[]" >
                                                                                        
                                                                                            <?php $__currentLoopData = $spec; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specify_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                            <?php $spat="";$spoth=''; ?>
                                                                                            <?php $__currentLoopData = $productspecs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pres): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                            <?php if($specifi[$i]->id==$pres->spec_id && ($specify_value == $pres->specify_value)): ?>
                                                                                            <?php $spat="selected"; ?>
                                                                                            
                                                                                            <?php elseif($specifi[$i]->id==$pres->spec_id && ($pres->specify_value=='Others')): ?>
                                                                                            <?php $spoth="selected"; ?>
                                                                                            <?php endif; ?>
                                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                                                    <option value="<?php echo e($specify_value); ?>" <?php echo e($spat); ?>> <?php echo e($specify_value); ?> </option>
                                                                                            ...
                                                                                            // }
                                                                                            ?>
                                                                                            <option value="Others" <?php echo e($spoth); ?>>Others</option>
                                                                                        </select>
                                                                    ...
                                                                    <div class="row mt-3">
                                                                        ...
                                                                        <div class="col-md-3 ">
                                                                            <select class="form-select form-select-lg text-secondary"
                                                                                ...
                                                                                <option value="<?php echo e($offer->id); ?>" <?php echo e(($offer->id == $product->offers)?'selected':''); ?>>
                                                                        ...
                                                                        <div class="col-md-4 ">
                                                                            <select class="form-select form-select-lg text-secondary"
                                                                                ...
                                                                                <option hidden value="<?php echo e($product->collection); ?>"><?php echo e($product->collection); ?></option>
                                                                                <?php $__currentLoopData = $productcollection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <script type="text/javascript">
        ...
        $('#main_category').on('change', function() {
            ...
            let url = '<?php echo e(route('getCategory')); ?>?main_category_id=' + main_category_id;
            let method = 'GET';
        ...
        $('#category').on('change', function() {
            ...
            let url = '<?php echo e(route('getSubCategory')); ?>?category_id=' + category_id;
            let method = 'GET';
            getAjaxValue(url, method, function(data) {
                $('#sub_category').empty();
                $('#sub_category').append(
    ...
    // });
        ...
        //     let url1 = '<?php echo e(route('getSpecifications')); ?>';
        //     let method1 = 'GET';
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/admin/products/EditProduct.blade.php ENDPATH**/ ?>