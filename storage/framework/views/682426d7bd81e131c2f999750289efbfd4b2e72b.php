                        ...
                        `<tr><td>${spec.name}</td><td>
                            ...
                            ${(function fun(array) {
                                for (let index = 0; index < array.length; index++) {
                                    options += `<option value='${index}'> ${array[index]}</option>`;
                                }
                                return options;
                            })(JSON.parse(spec.value))}
                        </select>
                        <input type="hidden" name="specify_attribute[]" value="${spec.id}">
                        </td></tr>`;
                });
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\skap\oxygen-new\resources\views/layout/vendor/products/add-product.blade.php ENDPATH**/ ?>