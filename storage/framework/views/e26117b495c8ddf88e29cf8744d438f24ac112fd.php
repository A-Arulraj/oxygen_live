                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                                ...
                                <div class="card-body">
                                <a href="<?php echo e(route('staffactivitycreate')); ?>" class="btn  btn-primary"><i class="fa fa-plus"></i> Add Activity</a>
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/staff/activity/activity-list.blade.php ENDPATH**/ ?>