                    ...
                    <div class="col-md-5 m-auto p-0">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <br>
                                <form action="<?php echo e(route('stafflogin')); ?>" method="post">
                                 <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/auth/stafflogin.blade.php ENDPATH**/ ?>