                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                                ...
                                <div class="card-body">
                                <a href="<?php echo e(url('staff/staff/create')); ?>" class="btn  btn-primary"><i class="fa fa-plus"></i> Add Staff</a>
...
<table class="table" id="table"  data-click-to-select="true"  data-sort-name="id" data-sort-order="asc" data-mobile-responsive="true" data-toggle="table" data-show-columns="true" data-sort="true" data-pagination="true" data-search="true"  data-show-refresh="true" data-key-events="true"  data-resizable="true" data-cookie="true"
     data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                    ...
                                    <tr>
                                        ...
                                        <form action="<?php echo e(route('sstaff.destroy',$stf->id)); ?>" method="POST">
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/staff/staff/staff-list.blade.php ENDPATH**/ ?>