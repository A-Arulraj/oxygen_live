...
use App\Models\vendor\Category\Category;
...
class CategorySubController extends Controller
{
    ...
    public function store(Request $request, FlasherInterface $flasher)
    {
        ...
        $statement = DB::select("SHOW TABLE STATUS LIKE 'vendor_category_sub'");
        ...
        try {
            ...
            $sub_category->flag = 1;
            $sub_category->created_by = 'vendor'; /*auth()->user()->id*/;
            $sub_category->created_byid = $login_id;
