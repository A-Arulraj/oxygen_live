									...
									<form method="post" action="<?php echo e(url('admin/staff/update', $staff->id)); ?>" class="needs-validation user-add" novalidate="" enctype="multipart/form-data">
										...
										<div class="form-group row">
											...
											<div class="col-xl-8 col-md-8">
												<input class="form-control" id="empid" type="readonly" required="true" name="empid" value="<?php echo e($staff->employee_id); ?>">
									...
									<div class="form-group row">
										...
										<div class="form-group row">
											...
											<select class="custom-select w-100 form-control" id="department" name="department" value="<?php echo e($staff->department); ?>" required="true">
																...
																<option hidden value="<?php echo e($staff->department); ?>" selected><?php echo e($item->name); ?></option>
										...
										<div class="form-group row">
											...
											<div class="col-xl-8 col-md-8">
												<select class="custom-select w-100 form-control" id="designation" name="designation"  required="true">
																...
																<option  value="<?php echo e($staff->designation); ?>" hidden selected  ><?php echo e($item->designation); ?></option>															
																<option value="<?php echo e($item->id); ?>" hidden><?php echo e($item->name); ?></option>
																<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>															
												</select>
											</div>
										</div>
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="tab-pane fade" id="top-upload" role="tabpanel" aria-labelledby="top-upload-tab">
                                        ...
                                        <h5 class="f-w-600">Upload</h5>
											...
											<input class="form-control" id="emp_id" value="<?php echo e($staff->employee_id); ?>" name ="emp_id" type="readonly"  name="profileimage" multiple /></br>
										 ...
										 <div class="form-group row">
                                            ...
                                            <h5 class="f-w-600">Other Information</h5>
												...
												<div class="form-group row">
													...
													<select class="custom-select w-100 form-control" required=""  value="<?php echo e($staff->zone_id); ?>">
												...
												<div class="form-group row">
													...
													<div class="col-xl-8 col-md-8">
														<select class="custom-select w-100 form-control" value="<?php echo e($staff->route_id); ?>" required="">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\mano\oxygen-new\resources\views/layout/admin/staff/staff-edit.blade.php ENDPATH**/ ?>