...
<!-- header start -->
   <?php echo $__env->make('paritials.website.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <!-- <div class="popup-filter"> -->
                <!-- <div class="sidebar-popup"><a class="popup-btn">filterrrrrrrrr
                            products</a></div> -->
                            <form  method="POST" action ="<?php echo e(route('subfilterproducts')); ?>">
                                                            <?php echo csrf_field(); ?>
                                                        <div class="open-popup">
                                                            <div class="collection-filter">
                                                                ...
                                                                <div class="collection-filter-block">
                                                                    ...
                                                                    <input type="hidden" id="cate1" name="cate1" value="<?php echo e($subcategory_id); ?>">
                                                                            ...
                                                                            <div class="collection-brand-filter">
                                                                                ...
                                                                                <div class="col-12">
                                                                                    <div class="text-end button_bottom">
                                                                                        ...
                                                                                        <a href="<?php echo e(url( 'Subcategoryproductshow/'.$subcategory_id )); ?>"
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="collection-product-wrapper">
                                        <h6 class="title-inner1 text-left">HOME / <?php echo e(strtoupper($category->category_main_name)); ?> / <?php echo e(strtoupper($category->category_name)); ?> / <?php echo e(strtoupper($category->category_sub_name)); ?> </h6>
                                        <p><b><?php echo e(strtoupper($category->category_sub_name)); ?> <?php echo e(count($product)); ?> items</b></p>   
    ...
    <script>
        ...
        ({
        type: "POST",
        url: "<?php echo e(route("subfilterproducts")); ?>",
        // data: dataString,
        data: {
    ...
    <?php echo $__env->make('website.front-end.newfooter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/website/front-end/viewsubcategory_products.blade.php ENDPATH**/ ?>