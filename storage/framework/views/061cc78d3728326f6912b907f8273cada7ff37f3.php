                                        ...
                                        <?php $__currentLoopData = $attribute; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><!--span> <a href="#" class="badge badge-secondary px-2"
                                                	 ...
                                                	 <form
																action="<?php echo e(route('attribute.master.destroy', $attribute->id)); ?>"
																method="post">
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/staff/products/attribute-listing.blade.php ENDPATH**/ ?>