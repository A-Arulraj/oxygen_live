                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="" method="post" action="<?php echo e(route('staffDepartmentssave')); ?>"
                                                        id="form">
                                                        <?php echo csrf_field(); ?>
                                                        <div class="form">
                                                    ...
                                                    <td><span class="d-flex"> 
                                                        <button type="button" class="edit_department btn btn-secondary mx-1" value="<?php echo e($department->id); ?>">
                                                            <i class="fa fa-pencil"></i></button>
                                                                    ...
                                                                    <form
                                                                    action="<?php echo e(route('staffdepartmentdelete', $department->id)); ?>"
                                                                    method="post">
...
<?php $__env->startPush('scripts'); ?>
            ...
            $(function() {
                var validation_option = getValidationOptions({
                    rules: {
                        name: {
                            required: true,
                            remote: {
                                url: "<?php echo e(route('staffcheckDepartmentnamePost')); ?>",
                                type: "post",
                                data: {
                                    name: function() {
                                        return $("#name").val();
                ...
                function save(callBack) {
                    if ($('#form').valid()) {
                        ...
                        var url = "<?php echo e(route('staffDepartmentssave')); ?>";
    ...
    $.ajax({
        //   data: $('').serialize(),  <?php echo e(url('admin/pincode1')); ?>/"+pin_id+"/edit"
          url: "<?php echo e(url('staff/editdepartment')); ?>/"+id+"/edit",          
          type: "get",
          dataType: 'json',
    ...
    $.ajax({
        //   data: $('').serialize(),    <?php echo e(url('admin/zonalupdate')); ?>/"+id+"/update"
             // url: "<?php echo e(url('admin/zonalupdate')); ?>/"+updateid,
              //console.log(id);
         url: "<?php echo e(url('staff/departmentupdate')); ?>/"+id+"/update", 
         type: "POST",
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/staff/master/department.blade.php ENDPATH**/ ?>