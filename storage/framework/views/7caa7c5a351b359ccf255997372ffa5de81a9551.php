			...
			<div class="row">
				<div class="col-sm-12">
					<div class="card">
						...
						<td>
                         <label class="switch">
							<?php if($item->designation_status  == 1): ?>{
								<input type="checkbox"
...
<script>
  ...
  //  var url ="<?php echo e(route('zonalupdate', ":updateid")); ?>";
   // url = url.replace(":updateid", updateid);
	...
	<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\mano\oxygen-new\resources\views/layout/admin/master/designation.blade.php ENDPATH**/ ?>