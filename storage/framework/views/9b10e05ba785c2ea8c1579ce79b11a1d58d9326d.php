		...
		<div class="container-fluid">
			<div class="card tab2-card">
				...
				<div class="card-body">
							...
							<form class="needs-validation" action="<?php echo e(route('auction.update',$auction->id)); ?>" method="post" novalidate="" >
								<?php echo csrf_field(); ?>
								...
								<div class="row fw-bold">
									<div class="col-sm-12">
									    ...
									    <div class="form-group row">
											...
											<div class="col-md-7">
												<input class="form-control" id="start_price" name="start_price" value="<?php echo e($auction->start_price); ?>" type="text"  onkeyup = "add()" value="" required="" >
											</div>											
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-md-7">
												<input class="form-control" id="slab" name="slab" value="<?php echo e($auction->slab); ?>" type="text" onkeyup = "add()" value="" required="">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-md-7">
												<input class="form-control" id="bid_price" name="bid_price" value="<?php echo e($auction->bid_price); ?>" type="text" required="" >
											</div>											
										</div>
									...
									<td></td>
										...
										<button class="btn btn-primary" type="submit">Save</button>
                                                    <a href="<?php echo e(route('auction/list')); ?>" class="btn btn-secondary" type="button">Close</a>
									</div>
								</div>
							</form>
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/admin/auction/auction-edit.blade.php ENDPATH**/ ?>