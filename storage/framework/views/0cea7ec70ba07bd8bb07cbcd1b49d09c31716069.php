                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body order-datatable">
                                ...
                                <br>
                                <form action="<?php echo e(route('searchdetails')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                          ...
                                          <div class="col-md-3" style="margin-top:35px;">
                                                ...
                                                <button class="btn btn-primary" type="submit" name ="submit">Search</button>
                                                 <a href="<?php echo e(route('vendorattribute.master.index')); ?>"class="btn btn-primary" type="submit" name ="submit">clear</a>
                                          </div>
                                        ...
                                        <?php $spc++; ?>
                                            <tr>
                                                ...
                                                <td>
                                                	...
                                                	<form action="<?php echo e(route('vendorattribute.master.destroy', $attribute->id)); ?>"
																method="post">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="" method="post" action="<?php echo e(route('vendorattribute.master.store')); ?>"
...
/*Edit Attripute*/ 
    ...
    $.ajax({
        //   data: $('').serialize(),  <?php echo e(url('admin/pincode1')); ?>/"+pin_id+"/edit"
          url: "<?php echo e(url('vendar/editattribute')); ?>/"+id+"/edit",          
          type: "get",
          dataType: 'json',
    ...
    function showModal() {
        ...
        $(document).on('submit','#UPDATEFORM', function(e){
            ...
            var url ="<?php echo e(route('vendorattributeupdate', ":updatecate_id")); ?>";
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/vendor/products/attribute-listing.blade.php ENDPATH**/ ?>