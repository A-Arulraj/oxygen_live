 <footer class="footer-light">
                ...
                <div class="row footer-theme partition-f">
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="footer-contant">
                            <div class="footer-logo"><img src="<?php echo e(asset('assets/img/logo/logo.png')); ?>" alt=""></div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6 col-sm-12">
                        <div class="payment-card-bottom">
                            <ul>
                                <li>
                                    <a href="#"><img src="<?php echo e(asset('assets/images/icon/visa.png')); ?>" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="<?php echo e(asset('assets/images/icon/mastercard.png')); ?>" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="<?php echo e(asset('assets/images/icon/paypal.png')); ?>" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="<?php echo e(asset('assets/images/icon/american-express.png')); ?>" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="<?php echo e(asset('assets/images/icon/discover.png')); ?>" alt=""></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xs-12">
                            <div class="quick-view-img"><img src="<?php echo e(asset('assets/images/pro3/1.jpg')); ?>" alt=""
    ...
    <script src="<?php echo e(asset('assets/js/color-setting.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/script.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/custom-slick-animated.js')); ?>"></script>
...
</html><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/website/front-end/newfooter.blade.php ENDPATH**/ ?>