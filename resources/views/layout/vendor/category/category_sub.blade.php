                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="" method="post"
                                                        action="{{ route('vendorcategory.sub.store') }}"
...
{{-- EDIT PAGE --}}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="d-flex">
                                                            ...
                                                            <form
                                                                action="{{ route('vendorcategory.sub.destroy', $sub_category->me_id) }}"
                                                                method="post">
                                                                @method('DELETE')
                                                                @csrf
    ...
    //  alert(cate_id);
      ...
      var url ="{{route('vendorcategory.sub.edit', ":cate_id")}}";
    ...
    //         });
        ...
        var url ="{{route('vendorsubcategory_update', ":updatecate_id")}}";
