                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">												
                                                    <form class="" action="<?php echo e(route('staffadvoxygen.store')); ?>" method="post" onsubmit="return confirm('Are you sure, you want to Save it?')" enctype="multipart/form-data" >
                                                        <?php echo csrf_field(); ?>
                                                        <div class="form">
                                    ...
                                    <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" data-backdrop="false" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">												
                                                    <form class="" action="<?php echo e(route('staffadvoxygen.update', 0)); ?>" method="post" onsubmit="return confirm('Are you sure, you want to Update it?')" enctype="multipart/form-data" >
                                                        <?php echo csrf_field(); ?>
                                ...
                                <table class="table" id="table"  data-click-to-select="true"  data-sort-name="id" data-sort-order="asc" data-mobile-responsive="true" data-toggle="table" data-show-columns="true" data-sort="true" data-pagination="true" data-search="true"  data-show-refresh="true" data-key-events="true"  data-resizable="true" data-cookie="true"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <img src="<?php echo e(asset('assets/images/banners/advoxygen') . '/' .$item->image); ?>" alt="" class="img-fluid img-30 me-2 blur-up lazyloaded">
                                                </div>
                                            </td>
                                            <td style="width:100%;">
                                            ...
                                            <label class="switch">
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    onclick="return confirm('you want to Change it?  Please Click Edit Button')" 
                                                     id="togBtn">                                                            
                                                <?php endif; ?>                                            <div class="slider round"><!--ADDED HTML -->
                                            ...
                                            <td>
                                                <span class="d-flex">
                                                  ...
                                                  <form
                                                     action="<?php echo e(route('staffadvoxygen.destroy', $item->id)); ?>"
                                                     method="post">
...
<script>
    $(document).on('click', '.edit_advbaner', function(e){
        ...
        var url = "<?php echo e(route('staffeditadvoxygen', ":ad_id")); ?>";
...
//       //    console.log(pin_id);
//       $('#exampleModal1').modal('show');
//       var url ="<?php echo e(route('editadvoxygen', ":cate_id")); ?>";
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/staff/banner/advoxygen.blade.php ENDPATH**/ ?>