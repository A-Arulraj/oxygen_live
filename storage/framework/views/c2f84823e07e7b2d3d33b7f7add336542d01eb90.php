                    ...
                    <div class="col-xl-10">
                        <div class="card tab2-card">
                            <div class="card-body" style="font-family: Times New Roman, Times, serif;">
                                ...
                                <form class="" method="post" action="<?php echo e(route('vendorcreate.update', $vendorcreate->id)); ?>"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label for="validationCustom0" class="col-xl-4 col-md-4"> User
                                                            Name</label>
                                                        <div class="col-xl-8 col-md-8">
                                                            <input class="form-control" id="validationCustom0" value=<?php echo e($vendorcreate->username); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xl-8 col-md-8">
                                                            <input class="form-control" id="pass" value=<?php echo e($vendorcreate->pass); ?>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label for="validationCustom0" class="col-xl-4 col-md-4"> Confirm
                                                            Password</label>
                                                        <div class="col-xl-8 col-md-8">
                                                            <input class="form-control" id="confirm_pass" type="password" value=<?php echo e($vendorcreate->pass1); ?>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="validationCustom0" class="col-xl-4 col-md-4"> Shop
                                                            Name</label>
                                                        <div class="col-xl-8 col-md-8">
                                                            <input class="form-control" id="validationCustom0" value=<?php echo e($vendorcreate->shop_name); ?>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label for="validationCustom0" class="col-xl-4 col-md-4"> Owner
                                                            Name</label>
                                                        <div class="col-xl-8 col-md-8">
                                                            <input class="form-control" id="" type="text" value=<?php echo e($vendorcreate->owner_name); ?>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="validationCustom0" class="col-xl-4 col-md-4"> Business
                                                            Category</label>
                                                        <div class="col-xl-8 col-md-8">
                                                            <input class="form-control" id="business_category" value=<?php echo e($vendorcreate->business_category); ?>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xl-8 col-md-7">
                                                            <input class="form-control" id="email" type="email" value=<?php echo e($vendorcreate->email); ?>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="validationCustom0" class="col-xl-4 col-md-4"> Mobile
                                                            Number</label>
                                                        <div class="col-xl-8 col-md-8">
                                                            <input class="form-control" id="m_number" type="text" value=<?php echo e($vendorcreate->mobile_number1); ?>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label for="validationCustom0" class="col-xl-4 col-md-4">Alternate
                                                            Number</label>
                                                        <div class="col-xl-8 col-md-8">
                                                            <input class="form-control" id="alter_no" type="text" value=<?php echo e($vendorcreate->mobile_number2); ?>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="validationCustom0" class="col-xl-4 col-md-4"> Address
                                                            I</label>
                                                        <div class="col-xl-8 col-md-8">
                                                            <input class="form-control" id="validationCustom0" value=<?php echo e($vendorcreate->address); ?>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label for="validationCustom0" class="col-xl-4 col-md-4">Address
                                                            II</label>
                                                        <div class="col-xl-8 col-md-8">
                                                            <input class="form-control" id="validationCustom0" value=<?php echo e($vendorcreate->address1); ?>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xl-8 col-md-8">
                                                            <select class="custom-select w-100 form-control" 
                                                                name="state">
                                                                <option value="<?php echo e($vendorcreate->state); ?>" selected hidden><?php echo e($vendorcreate->state); ?></option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xl-8 col-md-8">
                                                            <select class="custom-select w-100 form-control" 
                                                                name="city">
                                                                <option value="<?php echo e($vendorcreate->city); ?>" selected hidden><?php echo e($vendorcreate->city); ?></option>
                                                                <option value="">--Select--</option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label for="validationCustom0" class="col-xl-4 col-md-4">
                                                            Pincode</label>
                                                        <div class="col-xl-8 col-md-8">
                                                            <input class="form-control" id="pincode" type="text" value=<?php echo e($vendorcreate->pincode); ?>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label for="validationCustom0" class="col-xl-4 col-md-4">Location
                                                            Map</label>
                                                        <div class="col-xl-8 col-md-8">
                                                            <input class="form-control" id="validationCustom0" value=<?php echo e($vendorcreate->location_map); ?>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xl-8 col-md-8">
                                                            ...
                                                            <select class="form-control" name="zone" >
                                                                ...
                                                                <option value="<?php echo e($vendorcreate->zone); ?>" selected hidden><?php echo e($vendorcreate->zone); ?></option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xl-8 col-md-7">
                                                            <input class="form-control" id="validationCustom2" value=<?php echo e($vendorcreate->route); ?>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="validationCustom0" class="col-xl-4 col-md-4"> AADHAR
                                                            NUMBER</label>
                                                        <div class="col-xl-8 col-md-8">
                                                            <input class="form-control" id="validationCustom0" value=<?php echo e($vendorcreate->aadhar_no); ?>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label for="validationCustom2" class="col-xl-4 col-md-4">GST
                                                            NUMBER</label>
                                                        <div class="col-xl-8 col-md-7">
                                                            <input class="form-control" id="validationCustom2" value=<?php echo e($vendorcreate->gst_number); ?>
                                        ...
                                        <div class="tab-pane fade" id="top-upload" role="tabpanel"
                                            ...
                                            <div class="form-group mt-4 row">
                                                ...
                                                <div class="col-xl-10 col-md-10">
                                                    <input class="form-control" id="fileUpload" type="file" 
                                                        ...
                                                        <input type="hiden" id="oldprofile_image" name="oldprofile_image" value=<?php echo e($vendorcreate->profile_image); ?>>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-xl-10 col-md-10">
                                                    <input class="form-control" id="fileUpload1" type="file" 
                                                        ...
                                                        <input type="hiden" id="oldgst" name="oldgst" value=<?php echo e($vendorcreate->gst); ?>>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-xl-10 col-md-10">
                                                    <input class="form-control" id="fileUpload1" type="file" 
                                                        ...
                                                        <input type="hiden" id="oldother_documents" name="oldother_documents" value=<?php echo e($vendorcreate->other_documents); ?>>
                                                    <div id="image-holder1"></div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xl-8 col-md-8">
                                                            ...
                                                            <select class="custom-select w-100 form-control"
                                                                ...
                                                                <?php $__currentLoopData = $pack; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pack): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    
                                                                    <option value="<?php echo e($pack->id); ?>" <?php echo e($pack->id == $vendorcreate->package_id ? 'selected' : ''); ?>><?php echo e($pack->name); ?>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label for="validationCustom0" class="col-xl-4 col-md-4">Purchase
                                                            Date</label>
                                                        <div class="col-xl-8 col-md-8">
                                                            <input id="datePicker" type="date" value=<?php echo e($vendorcreate->purchase_date); ?>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label for="validationCustom0" class="col-xl-4 col-md-4">Days
                                                            Validity</label>
                                                        <div class="col-xl-8 col-md-8">
                                                            <input class="form-control" id="validity" type="text"  value=<?php echo e($vendorcreate->validity); ?>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label for="validationCustom0" class="col-xl-4 col-md-4">++
                                                            Days</label>
                                                        <div class="col-xl-8 col-md-8">
                                                            <input class="form-control" id="grace_days" type="text" value=<?php echo e($vendorcreate->grace_days); ?> name="grace_days">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="validationCustom0" class="col-xl-4 col-md-4">Expired
                                                            Date</label>
                                                        <div class="col-xl-8 col-md-8">
                                                            <input id="expired_date" type="date" class="form-control " value=<?php echo e($vendorcreate->expired_date); ?>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label for="validationCustom0" class="col-xl-4 col-md-4">Next
                                                            Renewal Date</label>
                                                        <div class="col-xl-8 col-md-8">
                                                            <input id="next_renewal_date" type="date" value=<?php echo e($vendorcreate->next_renewal_date); ?>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="validationCustom0" class="col-xl-4 col-md-4">ADD
                                                            Wallets</label>
                                                        <div class="col-xl-8 col-md-8">
                                                            <input class="form-control" id="wallet" type="text" value=<?php echo e($vendorcreate->wallet); ?>  name="wallet">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xl-8 col-md-8">
                                                            <input class="form-control" id="commission" value=<?php echo e($vendorcreate->commission); ?>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-xl-10 col-md-10">
                                                    ...
                                                    <textarea class="form-control"  rows="3" id="description" name="description"  type="text" name="description"><?php echo e($vendorcreate->description); ?></textarea>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xl-9 col-md-9">
                                                            <input class="form-control" id="bank_name" name="bank_name" type="text"  value=<?php echo e($vendorcreate->bank_name); ?>>
                                                          </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="validationCustom0" class="col-xl-3 col-md-3"> Account
                                                            Number</label>
                                                        <div class="col-xl-9 col-md-9">
                                                            <input class="form-control" id="ac_no" name="ac_no" type="text" value=<?php echo e($vendorcreate->ac_no); ?>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xl-9 col-md-9">
                                                            <input class="form-control" id="ac_no1"   name="ac_no1" type="text" value=<?php echo e($vendorcreate->ac_no1); ?>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="validationCustom0" class="col-xl-3 col-md-3"> IFSC
                                                            Code </label>
                                                        <div class="col-xl-9 col-md-9">
                                                            <input class="form-control" id="ifsc"   name="ifsc"  type="text" value = <?php echo e($vendorcreate->ifsc); ?>>
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xl-9 col-md-9">
                                                            <input class="form-control" id="upi"  name="upi" type="text" value=<?php echo e($vendorcreate->upi); ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            ...
                                                            <input type="checkbox" class="form-check-input"
                                                                id="check1" name="option1" <?php echo e($vendorcreate->option1 == 'mobile' ? 'checked': ''); ?>     value="mobile">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="checkbox" class="form-check-input"
                                                                id="check2" name="option2"  <?php echo e($vendorcreate->option2 == 'delivery' ? 'checked': ''); ?>   value="delivery">
                                                        ...
                                                        <div class="row mt-3">
                                                            ...
                                                            <div class="col-xl-5 col-md-5">
                                                                <textarea class="form-control" rows="3" id="validationCustom1" type="text" name="comments"><?php echo e($vendorcreate->comments); ?></textarea>
                                                            </div>
                                                        </div><br>
                                                        ...
                                                        <div class="">
                                                           ...
                                                           <a href="<?php echo e(url('vendor/list')); ?>"> 
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#package').on('click', function() {
                ...
                if (package) {
                    $.ajax({
                        url: "<?php echo e(route('Ajaxpackage')); ?>",
                        type: "POST",
                        data: {
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/admin/vendor/vendor-edit.blade.php ENDPATH**/ ?>