                    ...
                    <div class="col-xl-10">
                        <div class="card tab2-card">
                            <div class="card-body" style="font-family: Times New Roman, Times, serif;">
                                ...
                                <form class="" method="post" action="<?php echo e(route('staffvendorcreate.store')); ?>"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xl-8 col-md-8">
                                                             <input class="form-control" readonly
                                                                value="<?php echo e(session()->get('username')); ?>"
        ...
        $(function() {
            ...
            function save(callBack) {
                if ($('#form').valid()) {
                    ...
                    var url = "<?php echo e(route('staffsaveZonals')); ?>";
        ...
        $(document).ready(function() {
            ...
            $('#package').on('click', function() {
               ...
               // alert(package);
                if (package) {
                    $.ajax({
                        // '<?php echo e(url('Ajaxpackage')); ?>'
                       // url:'/admin/Ajaxpackage',
                        //action: "<?php echo e(route('Ajaxpackage')); ?>",    <?php echo e(route('checkZonalnamePost')); ?>

                        url : "<?php echo e(route('staffAjaxpackage')); ?>",
                        type: "POST",
                        data: {
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/staff/vendor/vendor-create.blade.php ENDPATH**/ ?>