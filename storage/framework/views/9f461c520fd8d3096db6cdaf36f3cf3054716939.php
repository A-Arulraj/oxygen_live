                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                          ...
                          <a href="<?php echo e(route('coupon.index')); ?>" class="btn mb-4 btn-primary"><i class="fa fa-plus"></i> Add Coupon </a> 
                       ...
                       <td><?php echo e($coupondata->end_date); ?></td>
                        ...
                        <td>
                            <span class="mt-3 d-flex"> 
                                <form action="<?php echo e(route('coupon.edit', $coupondata->id)); ?>"
                                    method="get">
                                ...
                                onclick="return confirm('Are you sure, you want to Edit it?')"
                                    ...
                                    <form action="<?php echo e(route('coupon.destroy', $coupondata->id)); ?>"
                                        method="post">
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/admin/coupon/list-coupon.blade.php ENDPATH**/ ?>