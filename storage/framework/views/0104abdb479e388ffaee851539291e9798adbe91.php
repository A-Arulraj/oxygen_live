                                        ...
                                        <div class="row">
                                            ...
                                            <div data-role="dynamic-fields">
                                             <div class="form-inline form-row">
                                                    ...
                                                    <div class="w row">
                                                        <div class="col-md-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control add_product" type="file" id="im<?php echo e($key); ?>" name="nproducts[]"  multiple accept="image/*">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <div class="row mt-3">
                                                                ...
                                                                <div class="col-md-1 ">
                                                                     <a href="#" class="remove_field h6 btn btn-sm bg-warning m-0" id="remove_field<?php echo e($inc); ?>" value= "<?php echo e($productdetails->id); ?>" >remove</a>
                                                ...
                                                <div class="col-md-12" id="r<?php echo e($key); ?>"> 
...
$(document).on("click", ".remove_field", function(e) { //user click on remove text
  ...
  //  alert(pid);
     let url = '<?php echo e(route('productsdetailsdelete')); ?>?id=' + pid;
//  alert(url);
      let method = 'POST';
...
/*image preview*/
    ...
    </script><?php /**PATH F:\oxygen-new\resources\views/layout/admin/products/producteditDetails.blade.php ENDPATH**/ ?>