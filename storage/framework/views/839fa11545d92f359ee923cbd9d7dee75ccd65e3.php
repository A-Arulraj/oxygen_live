   ...
   // alert('1');
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.sum == 0) {
                var cart_dt = '<li> <div class="minicart-item"><img src="' + url + '/frontend/assets/images/emptycart.png" alt="Your Cart Is Empty"> </div></li>';
            } else {
                cart_dt = "";
               // alert('2');
...
</script><?php /**PATH C:\xampp\htdocs\skap\oxygen-new\resources\views/paritials/js/userwebsite/cart_js.blade.php ENDPATH**/ ?>