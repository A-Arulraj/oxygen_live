...
<?php $__env->startSection('contents'); ?>
    <?php echo $__env->make('paritials.css.product.productlist-css', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('paritials.js.product.product-list-js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('paritials.css.display-css', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="container-fluid fcolor">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="mt-3">
                                <a href="<?php echo e(route('vendorproducts.crud.index')); ?>">
                                        ...
                                        // ->get
                                            ...
                                            <tr>
                                                ...
                                                if(count($produ) > 0)
                                                   ...
                                                   ?>
                                                <td><?php echo e($zone.'-'.$login_id.'-'.$pro_id); ?></td>
                                               
                                                <td>
                                                    <div class="d-flex">
                                                        <img src="<?php echo e(asset('assets/images/products') . '/' . $products->product_image); ?>"
                                                            alt="" class="img-fluid img-40 me-2 blur-up lazyloaded">
                                                    </div>
                                                </td>
                                                <td> 
                                                    
                                                    <?php echo e($products->product_name); ?></td>
                                                ...
                                                <td class="text-center">
                                                    <span class="fw-bold">
                                                        <a href="#" data-id=<?php echo e($products->id); ?>
                                                            ...
                                                            data-bs-target="#stockModal"><?php echo e($products->vendor_product_details_cnt); ?></a>
                                                ...
                                                for($i=0; $i< $categorysubcount; $i++){
                                                 ?>
                                                <?php if($categorysub[$i]->id == $products->category_sub): ?>
                                                <td><?php echo e($categorysub[$i]->category_sub_name); ?> </td>
                                                <?php endif; ?>
                                                <?php
                                                    }
                                                ?>
                                                <td><?php echo e($products->collection); ?></td>
                                                ...
                                                <td>
                                                    <div class="mt-2 d-flex">
                                                         ...
                                                         <a href="<?php echo e(route('vendorproducts.crud.edit', ['id'=>$products->product_id, 'sub_id'=>$products->category_sub])); ?>"
                                                            class="btn btn-secondary mx-1"><i class="fa fa-pencil"></i>
                                                        </a> 
                                                        <form action="<?php echo e(route('vendorproducts.crud.destroy', $products->id)); ?>"
                                                            method="post">
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <form action="<?php echo e(route('offer.update')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class="modal-body">
                                <div class="container-fluid">
                                    <div id="modal_body">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(".productDetails").click(function() {
                ...
                let url = '<?php echo e(route('getProductDetails')); ?>?product_id=' + product_id;
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/vendor/products/product-listing.blade.php ENDPATH**/ ?>