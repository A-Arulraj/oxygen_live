		...
		<div class="container-fluid">
			<div class="card tab2-card">
				...
				<div class="card-body">
							...
							<form class="needs-validation" action="<?php echo e(route('staffauction.store')); ?>" method="post" novalidate="" >
								<?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/staff/auction/create-auction.blade.php ENDPATH**/ ?>