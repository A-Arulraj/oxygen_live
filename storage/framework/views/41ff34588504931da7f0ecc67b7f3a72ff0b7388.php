...
<?php $__env->startSection('contents'); ?>
                                            ...
                                            <?php $__currentLoopData = $data->routeList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr>
                                                    <td><?php echo e($route->id); ?></td>
                                                    	<td>
                                                           ...
                                                           // dd($route->zonal_id);
                                                            ...
                                                            ?>
                                                            <?php $__currentLoopData = $zonal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zonal1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                             <?php if($zonal1->id == $route->zonal_id): ?>
                                                             
                                                                <?php echo e($zonal1->name); ?>
                                                    ...
                                                    <td><span class="d-flex"> 
                                                        ...
                                                        <button type="button" class="edit_route btn btn-secondary mx-1" value="<?php echo e($route->id); ?>">
                                                            <i class="fa fa-pencil"></i></button>
                                                                    ...
                                                                    <form
                                                                    action="<?php echo e(route('routedelete', $route->id)); ?>"
                                                                    method="post">
                                                                    <?php echo method_field('POST'); ?>
                                                                    <?php echo csrf_field(); ?>
                                                                    <button type="submit" class="btn btn-warning mx-1" value="<?php echo e($route->id); ?>"
                                                ...
                                                <div class="btn-popup pull-right">
                                                    ...
                                                    <div class="modal fade" id="edit<?php echo e($route->id); ?>" tabindex="-1" role="dialog"
                                                        data-backdrop="false" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                        ...
                                                                        <div class="form">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control"  type="text"
                                                                                    name="editname" id="editname" required="true" value="<?php echo e($route->name); ?>">
                                                                            </div>
    ...
    <?php $__env->startPush('scripts'); ?>
            ...
            $(function() {
                var validation_option = getValidationOptions({
                    rules: {
                        name: {
                            required: true,
                            remote: {
                                url: "<?php echo e(route('checRoutenamePost')); ?>",
                                type: "post",
                                data: {
                                    name: function() {
                                        return $("#name").val();
                ...
                function save(callBack) {
                    if ($('#form').valid()) {
                        ...
                        var url = "<?php echo e(url('admin/saveRoute')); ?>";
        ...
        <script>
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(url('admin/editroute')); ?>/"+id+"/edit",          
                    type: "get",
                    dataType: 'json',
    ...
    var url = '<?php echo e(route("route_update", ":id")); ?>';
    url = url.replace(':id', id );
   
    $.ajax({
              // url: "<?php echo e(url('admin/route_update')); ?>/"+id+"/update",
                 url: url,
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/admin/master/route.blade.php ENDPATH**/ ?>