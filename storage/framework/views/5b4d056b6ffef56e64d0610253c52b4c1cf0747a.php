...
<script src="<?php echo e(asset('assets/js/imask.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('assets/js/jsgrid/griddata-invoice.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/jsgrid/jsgrid-invoice.js')); ?>"></script>
...
<!--new-->
 ...
 <!-- jquery
    ...
    </html><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/paritials/auth/footer-js.blade.php ENDPATH**/ ?>