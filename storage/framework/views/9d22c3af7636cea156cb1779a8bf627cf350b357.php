                    ...
                    <div class="col-xl-10">
                        <div class="card tab2-card">
                            <div class="card-body" style="font-family: Times New Roman, Times, serif;">
                                ...
                                <form class="" method="post" action="<?php echo e(route('staffvendorcreate.update', $vendorcreate->id)); ?>"
                                    ...
                                    <div class="tab-content" id="top-tabContent">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xl-8 col-md-8">
                                                            <input class="form-control" id="validationCustom0" value=<?php echo e($vendorcreate->pass); ?>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label for="validationCustom0" class="col-xl-4 col-md-4"> Confirm
                                                            Password</label>
                                                        <div class="col-xl-8 col-md-8">
                                                            <input class="form-control" id="validationCustom0" type="password" value=<?php echo e($vendorcreate->pass1); ?>
                                                            ...
                                                            <select class="form-control" name="zone" >
                                                                ...
                                                                <option >Select Item</option>
                                                                 ...
                                                                 <?php $__currentLoopData = $zone; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                  <option value="<?php echo e($zo->name); ?>" > <?php echo e($zo->name); ?> </option>
                                        ...
                                        <div class="tab-pane fade" id="top-upload" role="tabpanel"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xl-8 col-md-8">
                                                            ...
                                                            <select class="custom-select w-100 form-control"
                                                                ...
                                                                <option value="<?php echo e($vendorcreate->package_id); ?>" selected hidden>
                                                                    <?php echo e($vendorcreate->package_id); ?>
                                                                ...
                                                                <?php $__currentLoopData = $pack; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pack): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($pack->id); ?>"><?php echo e($pack->name); ?>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label for="validationCustom0" class="col-xl-4 col-md-4">++
                                                            Days</label>
                                                        <div class="col-xl-8 col-md-8">
                                                            <input class="form-control" id="grace_days" type="text" value=<?php echo e($vendorcreate->grace_days); ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="validationCustom0" class="col-xl-4 col-md-4">ADD
                                                            Wallets</label>
                                                        <div class="col-xl-8 col-md-8">
                                                            <input class="form-control" id="wallet" type="text" value=<?php echo e($vendorcreate->wallet); ?>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xl-8 col-md-8">
                                                            <input class="form-control" readonly id="commission" value=<?php echo e($vendorcreate->commission); ?>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-xl-10 col-md-10">
                                                    <textarea class="form-control" readonly rows="3" id="description" value=<?php echo e($vendorcreate->description); ?>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xl-9 col-md-9">
                                                            <input class="form-control" id="bank_name" type="text"  value=<?php echo e($vendorcreate->bank_name); ?>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="validationCustom0" class="col-xl-3 col-md-3"> Account
                                                            Number</label>
                                                        <div class="col-xl-9 col-md-9">
                                                            <input class="form-control" id="ac_no" type="text" value=<?php echo e($vendorcreate->ac_no); ?>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xl-9 col-md-9">
                                                            <input class="form-control" id="ac_no1" type="text" value=<?php echo e($vendorcreate->ac_no1); ?>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="validationCustom0" class="col-xl-3 col-md-3"> IFSC
                                                            Code </label>
                                                        <div class="col-xl-9 col-md-9">
                                                            <input class="form-control" id="ifsc" type="text" value=<?php echo e($vendorcreate->ifsc); ?>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xl-9 col-md-9">
                                                            <input class="form-control" id="upi" type="text" value=<?php echo e($vendorcreate->upi); ?>
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/staff/vendor/vendor-edit.blade.php ENDPATH**/ ?>