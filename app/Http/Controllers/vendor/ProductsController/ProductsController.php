...
class ProductsController extends Controller
{
   ...
   public function store(Request $request, FlasherInterface $flasher)
    ...
    public function listing()
    {
        ...
        $products_list = Products::where('login_id', $vendor_id)->get();
         $categorySub = CategorySub::get();
    ...
    public function vendorlisting()
    {
      ...
      // $products_list = Products::get();
       $vendor_id = session()->get('login_id');
       $products_list = Products::where('login_id', $vendor_id)->where('logintype', "Vendor")->get();
      // dd($products_list);
