...
<?php $__env->startSection('contents'); ?>
                                                    ...
                                                    <td><span class="d-flex"> 
                                                        ...
                                                        <button type="button" class="edit_zonal btn btn-secondary mx-1" value="<?php echo e($data->id); ?>">
                                                         <i class="fa fa-pencil"></i></button>
                                                                    ...
                                                                    <form
                                                                    action="<?php echo e(route('staffzonaldelete', $data->id)); ?>"
                                                                    method="post">
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
                ...
                var validation_option = getValidationOptions({
                    rules: {
                        name: {
                            required: true,
                            remote: {
                                url: "<?php echo e(route('staffcheckZonalnamePost')); ?>",
                                type: "post",
                                data: {
                                    name: function() {
                                        return $("#name").val();
            ...
            function loadData() {
                var url = '<?php echo e(route('staffzonalsListingPost')); ?>';
            ...
            $('#DataTbl').on('click', 'a.update', function(e) {
                ...
                var link = '<?php echo e(route('staffzonalsListingPost', ':id')); ?>';
    ...
    $.ajax({
        //   data: $('').serialize(),  <?php echo e(url('admin/pincode1')); ?>/"+pin_id+"/edit"
          url: "<?php echo e(url('staff/editzonal')); ?>/"+id+"/edit",          
          type: "get",
          dataType: 'json',
    ...
    $.ajax({
        //   data: $('').serialize(),    <?php echo e(url('admin/zonalupdate')); ?>/"+id+"/update"
             // url: "<?php echo e(url('admin/zonalupdate')); ?>/"+updateid,
              //console.log(id);
              url: "<?php echo e(url('staff/zonalupdate')); ?>/"+id+"/update",
...
<?php echo $__env->make('layout.auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/layout/staff/master/zonal.blade.php ENDPATH**/ ?>