<div class="page-sidebar">
    ...
    <div class="sidebar custom-scrollbar mt-3">
        ...
        <ul class="sidebar-menu">
          ...
          <li><a class="sidebar-header" href="<?php echo e(url('admin/dashboard')); ?>"><i
            ...
            <li><a class="sidebar-header" href=""><i data-feather="database"></i><span>Master</span><i
                ...
                <ul class="sidebar-submenu">
                    ...
                    <li><a href="<?php echo e(route('aroute')); ?>"><i class="fa fa-circle"></i>Route</a></li>
...
<?php /**PATH /home/ktonline/public_html/oxygen.ktonline.in/resources/views/paritials/auth/sidemenu.blade.php ENDPATH**/ ?>